...
public class SubmissionValidation {
   ...
   *   <li>Filters validators to those whose {@link SubmissionValidator#appliesTo(String)} returns
   ...
   *     discovered
   */
  public ValidationResult validateSubmission(final SubmissionResponse submission, String scope) {
