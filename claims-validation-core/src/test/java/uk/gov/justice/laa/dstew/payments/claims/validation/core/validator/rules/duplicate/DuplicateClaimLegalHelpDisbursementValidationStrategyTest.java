...
import static uk.gov.justice.laa.dstew.payments.claims.validation.core.validator.ValidationServiceTestUtils.assertContextClaimError;
...
class DuplicateClaimLegalHelpDisbursementValidationStrategyTest
  ...
  @Mock DataClaimsClient dataClaimsRestClient;
  ...
  class ValidClaim {
    ...
    void shouldHaveNoErrorsWhenCurrentClaimNotDisbursement() {
      ...
      List<ValidationIssue> strategyIssues = duplicateClaimValidationService.validateDuplicateClaims(
          claimTobeProcessed,
