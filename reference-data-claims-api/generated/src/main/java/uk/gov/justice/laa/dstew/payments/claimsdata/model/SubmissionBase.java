...
@Schema(name = "submission_base", description = "submission details")
@JsonTypeName("submission_base")
...
public class SubmissionBase implements Serializable {
  ...
  public SubmissionBase submissionId(@Nullable UUID submissionId) {
  ...
  public SubmissionBase bulkSubmissionId(@Nullable UUID bulkSubmissionId) {
  ...
  public SubmissionBase officeAccountNumber(@Nullable String officeAccountNumber) {
  ...
  public SubmissionBase submissionPeriod(@Nullable String submissionPeriod) {
  ...
  public SubmissionBase areaOfLaw(@Nullable AreaOfLaw areaOfLaw) {
  ...
  public SubmissionBase providerUserId(@Nullable String providerUserId) {
  ...
  public SubmissionBase status(@Nullable SubmissionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public SubmissionBase crimeLowerScheduleNumber(@Nullable String crimeLowerScheduleNumber) {
  ...
  public SubmissionBase legalHelpSubmissionReference(@Nullable String legalHelpSubmissionReference) {
  ...
  public SubmissionBase mediationSubmissionReference(@Nullable String mediationSubmissionReference) {
  ...
  public SubmissionBase previousSubmissionId(@Nullable UUID previousSubmissionId) {
  ...
  public SubmissionBase isNilSubmission(@Nullable Boolean isNilSubmission) {
  ...
  public SubmissionBase numberOfClaims(@Nullable Integer numberOfClaims) {
  ...
  public SubmissionBase calculatedTotalAmount(@Nullable BigDecimal calculatedTotalAmount) {
  ...
  public SubmissionBase submitted(@Nullable OffsetDateTime submitted) {
  ...
  public SubmissionBase createdByUserId(@Nullable String createdByUserId) {
  ...
  public SubmissionBase errorMessages(@Nullable String errorMessages) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.submissionId, submissionBase.submissionId) &&
        Objects.equals(this.bulkSubmissionId, submissionBase.bulkSubmissionId) &&
        Objects.equals(this.officeAccountNumber, submissionBase.officeAccountNumber) &&
        Objects.equals(this.submissionPeriod, submissionBase.submissionPeriod) &&
        Objects.equals(this.areaOfLaw, submissionBase.areaOfLaw) &&
        Objects.equals(this.providerUserId, submissionBase.providerUserId) &&
        Objects.equals(this.status, submissionBase.status) &&
        Objects.equals(this.crimeLowerScheduleNumber, submissionBase.crimeLowerScheduleNumber) &&
        Objects.equals(this.legalHelpSubmissionReference, submissionBase.legalHelpSubmissionReference) &&
        Objects.equals(this.mediationSubmissionReference, submissionBase.mediationSubmissionReference) &&
        Objects.equals(this.previousSubmissionId, submissionBase.previousSubmissionId) &&
        Objects.equals(this.isNilSubmission, submissionBase.isNilSubmission) &&
        Objects.equals(this.numberOfClaims, submissionBase.numberOfClaims) &&
        Objects.equals(this.calculatedTotalAmount, submissionBase.calculatedTotalAmount) &&
        Objects.equals(this.submitted, submissionBase.submitted) &&
        Objects.equals(this.createdByUserId, submissionBase.createdByUserId) &&
        Objects.equals(this.errorMessages, submissionBase.errorMessages);
  }
  ...
  public static class Builder {
    ...
    private SubmissionBase instance;

    public Builder() {
      this(new SubmissionBase());
    }

    protected Builder(SubmissionBase instance) {
      this.instance = instance;
    }

    protected Builder copyOf(SubmissionBase value) { 
    ...
    public SubmissionBase.Builder submissionId(UUID submissionId) {
      this.instance.submissionId(submissionId);
      return this;
    }
    
    public SubmissionBase.Builder bulkSubmissionId(UUID bulkSubmissionId) {
      this.instance.bulkSubmissionId(bulkSubmissionId);
      return this;
    }
    
    public SubmissionBase.Builder officeAccountNumber(String officeAccountNumber) {
      this.instance.officeAccountNumber(officeAccountNumber);
      return this;
    }
    
    public SubmissionBase.Builder submissionPeriod(String submissionPeriod) {
      this.instance.submissionPeriod(submissionPeriod);
      return this;
    }
    
    public SubmissionBase.Builder areaOfLaw(AreaOfLaw areaOfLaw) {
      this.instance.areaOfLaw(areaOfLaw);
      return this;
    }
    
    public SubmissionBase.Builder providerUserId(String providerUserId) {
      this.instance.providerUserId(providerUserId);
      return this;
    }
    
    public SubmissionBase.Builder status(SubmissionStatus status) {
      this.instance.status(status);
      return this;
    }
    
    public SubmissionBase.Builder crimeLowerScheduleNumber(String crimeLowerScheduleNumber) {
      this.instance.crimeLowerScheduleNumber(crimeLowerScheduleNumber);
      return this;
    }
    
    public SubmissionBase.Builder legalHelpSubmissionReference(String legalHelpSubmissionReference) {
      this.instance.legalHelpSubmissionReference(legalHelpSubmissionReference);
      return this;
    }
    
    public SubmissionBase.Builder mediationSubmissionReference(String mediationSubmissionReference) {
      this.instance.mediationSubmissionReference(mediationSubmissionReference);
      return this;
    }
    
    public SubmissionBase.Builder previousSubmissionId(UUID previousSubmissionId) {
      this.instance.previousSubmissionId(previousSubmissionId);
      return this;
    }
    
    public SubmissionBase.Builder isNilSubmission(Boolean isNilSubmission) {
      this.instance.isNilSubmission(isNilSubmission);
      return this;
    }
    
    public SubmissionBase.Builder numberOfClaims(Integer numberOfClaims) {
      this.instance.numberOfClaims(numberOfClaims);
      return this;
    }
    
    public SubmissionBase.Builder calculatedTotalAmount(BigDecimal calculatedTotalAmount) {
      this.instance.calculatedTotalAmount(calculatedTotalAmount);
      return this;
    }
    
    public SubmissionBase.Builder submitted(OffsetDateTime submitted) {
      this.instance.submitted(submitted);
      return this;
    }
    
    public SubmissionBase.Builder createdByUserId(String createdByUserId) {
      this.instance.createdByUserId(createdByUserId);
      return this;
    }
    
    public SubmissionBase.Builder errorMessages(String errorMessages) {
      this.instance.errorMessages(errorMessages);
      return this;
    }
    
    /**
    * returns a built SubmissionBase instance.
    *
  ...
  */
  public static SubmissionBase.Builder builder() {
    return new SubmissionBase.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public SubmissionBase.Builder toBuilder() {
    SubmissionBase.Builder builder = new SubmissionBase.Builder();
