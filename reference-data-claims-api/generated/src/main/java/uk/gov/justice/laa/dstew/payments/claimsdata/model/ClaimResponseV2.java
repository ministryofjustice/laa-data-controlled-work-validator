...
@JsonTypeName("claim_response_v2")
...
public class ClaimResponseV2 implements Serializable {
  ...
  private @Nullable OffsetDateTime dateSubmitted;

  public ClaimResponseV2 id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ClaimResponseV2 submissionId(@Nullable String submissionId) {
  ...
  public ClaimResponseV2 status(@Nullable ClaimStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ClaimResponseV2 scheduleReference(@Nullable String scheduleReference) {
  ...
  public ClaimResponseV2 lineNumber(@Nullable Integer lineNumber) {
  ...
  public ClaimResponseV2 caseReferenceNumber(@Nullable String caseReferenceNumber) {
  ...
  public ClaimResponseV2 uniqueFileNumber(@Nullable String uniqueFileNumber) {
  ...
  public ClaimResponseV2 caseStartDate(@Nullable String caseStartDate) {
  ...
  public ClaimResponseV2 caseConcludedDate(@Nullable String caseConcludedDate) {
  ...
  public ClaimResponseV2 matterTypeCode(@Nullable String matterTypeCode) {
  ...
  public ClaimResponseV2 crimeMatterTypeCode(@Nullable String crimeMatterTypeCode) {
  ...
  public ClaimResponseV2 feeSchemeCode(@Nullable String feeSchemeCode) {
  ...
  public ClaimResponseV2 feeCode(@Nullable String feeCode) {
  ...
  public ClaimResponseV2 procurementAreaCode(@Nullable String procurementAreaCode) {
  ...
  public ClaimResponseV2 accessPointCode(@Nullable String accessPointCode) {
  ...
  public ClaimResponseV2 deliveryLocation(@Nullable String deliveryLocation) {
  ...
  public ClaimResponseV2 representationOrderDate(@Nullable String representationOrderDate) {
  ...
  public ClaimResponseV2 suspectsDefendantsCount(@Nullable Integer suspectsDefendantsCount) {
  ...
  public ClaimResponseV2 policeStationCourtAttendancesCount(@Nullable Integer policeStationCourtAttendancesCount) {
  ...
  public ClaimResponseV2 policeStationCourtPrisonId(@Nullable String policeStationCourtPrisonId) {
  ...
  public ClaimResponseV2 dsccNumber(@Nullable String dsccNumber) {
  ...
  public ClaimResponseV2 maatId(@Nullable String maatId) {
    this.maatId = maatId;
    return this;
  }
  ...
  public ClaimResponseV2 prisonLawPriorApprovalNumber(@Nullable String prisonLawPriorApprovalNumber) {
  ...
  public ClaimResponseV2 isDutySolicitor(@Nullable Boolean isDutySolicitor) {
  ...
  public ClaimResponseV2 isYouthCourt(@Nullable Boolean isYouthCourt) {
  ...
  public ClaimResponseV2 schemeId(@Nullable String schemeId) {
  ...
  public ClaimResponseV2 mediationSessionsCount(@Nullable Integer mediationSessionsCount) {
  ...
  public ClaimResponseV2 mediationTimeMinutes(@Nullable Integer mediationTimeMinutes) {
  ...
  public ClaimResponseV2 outreachLocation(@Nullable String outreachLocation) {
  ...
  public ClaimResponseV2 referralSource(@Nullable String referralSource) {
  ...
  public ClaimResponseV2 clientForename(@Nullable String clientForename) {
  ...
  public ClaimResponseV2 clientSurname(@Nullable String clientSurname) {
  ...
  public ClaimResponseV2 clientDateOfBirth(@Nullable String clientDateOfBirth) {
  ...
  public ClaimResponseV2 uniqueClientNumber(@Nullable String uniqueClientNumber) {
  ...
  public ClaimResponseV2 clientPostcode(@Nullable String clientPostcode) {
  ...
  public ClaimResponseV2 genderCode(@Nullable String genderCode) {
  ...
  public ClaimResponseV2 ethnicityCode(@Nullable String ethnicityCode) {
  ...
  public ClaimResponseV2 disabilityCode(@Nullable String disabilityCode) {
  ...
  public ClaimResponseV2 isLegallyAided(@Nullable Boolean isLegallyAided) {
  ...
  public ClaimResponseV2 clientTypeCode(@Nullable String clientTypeCode) {
  ...
  public ClaimResponseV2 homeOfficeClientNumber(@Nullable String homeOfficeClientNumber) {
  ...
  public ClaimResponseV2 claReferenceNumber(@Nullable String claReferenceNumber) {
  ...
  public ClaimResponseV2 claExemptionCode(@Nullable String claExemptionCode) {
  ...
  public ClaimResponseV2 client2Forename(@Nullable String client2Forename) {
  ...
  public ClaimResponseV2 client2Surname(@Nullable String client2Surname) {
  ...
  public ClaimResponseV2 client2DateOfBirth(@Nullable String client2DateOfBirth) {
  ...
  public ClaimResponseV2 client2Ucn(@Nullable String client2Ucn) {
  ...
  public ClaimResponseV2 client2Postcode(@Nullable String client2Postcode) {
  ...
  public ClaimResponseV2 client2GenderCode(@Nullable String client2GenderCode) {
  ...
  public ClaimResponseV2 client2EthnicityCode(@Nullable String client2EthnicityCode) {
  ...
  public ClaimResponseV2 client2DisabilityCode(@Nullable String client2DisabilityCode) {
  ...
  public ClaimResponseV2 client2IsLegallyAided(@Nullable Boolean client2IsLegallyAided) {
  ...
  public ClaimResponseV2 caseId(@Nullable String caseId) {
    this.caseId = caseId;
    return this;
  }
  ...
  public ClaimResponseV2 uniqueCaseId(@Nullable String uniqueCaseId) {
  ...
  public ClaimResponseV2 caseStageCode(@Nullable String caseStageCode) {
  ...
  public ClaimResponseV2 stageReachedCode(@Nullable String stageReachedCode) {
  ...
  public ClaimResponseV2 standardFeeCategoryCode(@Nullable String standardFeeCategoryCode) {
  ...
  public ClaimResponseV2 outcomeCode(@Nullable String outcomeCode) {
  ...
  public ClaimResponseV2 designatedAccreditedRepresentativeCode(@Nullable String designatedAccreditedRepresentativeCode) {
  ...
  public ClaimResponseV2 isPostalApplicationAccepted(@Nullable Boolean isPostalApplicationAccepted) {
  ...
  public ClaimResponseV2 isClient2PostalApplicationAccepted(@Nullable Boolean isClient2PostalApplicationAccepted) {
  ...
  public ClaimResponseV2 mentalHealthTribunalReference(@Nullable String mentalHealthTribunalReference) {
  ...
  public ClaimResponseV2 isNrmAdvice(@Nullable Boolean isNrmAdvice) {
  ...
  public ClaimResponseV2 followOnWork(@Nullable String followOnWork) {
  ...
  public ClaimResponseV2 transferDate(@Nullable String transferDate) {
  ...
  public ClaimResponseV2 exemptionCriteriaSatisfied(@Nullable String exemptionCriteriaSatisfied) {
  ...
  public ClaimResponseV2 exceptionalCaseFundingReference(@Nullable String exceptionalCaseFundingReference) {
  ...
  public ClaimResponseV2 isLegacyCase(@Nullable Boolean isLegacyCase) {
  ...
  public ClaimResponseV2 adviceTime(@Nullable Integer adviceTime) {
  ...
  public ClaimResponseV2 travelTime(@Nullable Integer travelTime) {
  ...
  public ClaimResponseV2 waitingTime(@Nullable Integer waitingTime) {
  ...
  public ClaimResponseV2 netProfitCostsAmount(@Nullable BigDecimal netProfitCostsAmount) {
  ...
  public ClaimResponseV2 netDisbursementAmount(@Nullable BigDecimal netDisbursementAmount) {
  ...
  public ClaimResponseV2 netCounselCostsAmount(@Nullable BigDecimal netCounselCostsAmount) {
  ...
  public ClaimResponseV2 disbursementsVatAmount(@Nullable BigDecimal disbursementsVatAmount) {
  ...
  public ClaimResponseV2 travelWaitingCostsAmount(@Nullable BigDecimal travelWaitingCostsAmount) {
  ...
  public ClaimResponseV2 netWaitingCostsAmount(@Nullable BigDecimal netWaitingCostsAmount) {
  ...
  public ClaimResponseV2 isVatApplicable(@Nullable Boolean isVatApplicable) {
  ...
  public ClaimResponseV2 isToleranceApplicable(@Nullable Boolean isToleranceApplicable) {
  ...
  public ClaimResponseV2 priorAuthorityReference(@Nullable String priorAuthorityReference) {
  ...
  public ClaimResponseV2 isLondonRate(@Nullable Boolean isLondonRate) {
  ...
  public ClaimResponseV2 adjournedHearingFeeAmount(@Nullable Integer adjournedHearingFeeAmount) {
  ...
  public ClaimResponseV2 isAdditionalTravelPayment(@Nullable Boolean isAdditionalTravelPayment) {
  ...
  public ClaimResponseV2 costsDamagesRecoveredAmount(@Nullable BigDecimal costsDamagesRecoveredAmount) {
  ...
  public ClaimResponseV2 meetingsAttendedCode(@Nullable String meetingsAttendedCode) {
  ...
  public ClaimResponseV2 detentionTravelWaitingCostsAmount(@Nullable BigDecimal detentionTravelWaitingCostsAmount) {
  ...
  public ClaimResponseV2 jrFormFillingAmount(@Nullable BigDecimal jrFormFillingAmount) {
  ...
  public ClaimResponseV2 isEligibleClient(@Nullable Boolean isEligibleClient) {
  ...
  public ClaimResponseV2 courtLocationCode(@Nullable String courtLocationCode) {
  ...
  public ClaimResponseV2 adviceTypeCode(@Nullable String adviceTypeCode) {
  ...
  public ClaimResponseV2 medicalReportsCount(@Nullable Integer medicalReportsCount) {
  ...
  public ClaimResponseV2 isIrcSurgery(@Nullable Boolean isIrcSurgery) {
  ...
  public ClaimResponseV2 surgeryDate(@Nullable String surgeryDate) {
  ...
  public ClaimResponseV2 surgeryClientsCount(@Nullable Integer surgeryClientsCount) {
  ...
  public ClaimResponseV2 surgeryMattersCount(@Nullable Integer surgeryMattersCount) {
  ...
  public ClaimResponseV2 cmrhOralCount(@Nullable Integer cmrhOralCount) {
  ...
  public ClaimResponseV2 cmrhTelephoneCount(@Nullable Integer cmrhTelephoneCount) {
  ...
  public ClaimResponseV2 aitHearingCentreCode(@Nullable String aitHearingCentreCode) {
  ...
  public ClaimResponseV2 isSubstantiveHearing(@Nullable Boolean isSubstantiveHearing) {
  ...
  public ClaimResponseV2 hoInterview(@Nullable Integer hoInterview) {
  ...
  public ClaimResponseV2 localAuthorityNumber(@Nullable String localAuthorityNumber) {
  ...
  public ClaimResponseV2 submissionPeriod(@Nullable String submissionPeriod) {
  ...
  public ClaimResponseV2 createdByUserId(@Nullable String createdByUserId) {
  ...
  public ClaimResponseV2 isAmended(@Nullable Boolean isAmended) {
  ...
  public ClaimResponseV2 hasAssessment(@Nullable Boolean hasAssessment) {
  ...
  public ClaimResponseV2 version(@Nullable Long version) {
  ...
  public ClaimResponseV2 areaOfLaw(@Nullable AreaOfLaw areaOfLaw) {
  ...
  public ClaimResponseV2 officeCode(@Nullable String officeCode) {
    this.officeCode = officeCode;
    return this;
  }

  /**
   * Account Office Code for this claim's submission.
   * @return officeCode
   */
  
  @Schema(name = "office_code", description = "Account Office Code for this claim's submission.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("office_code")
  public @Nullable String getOfficeCode() {
    return officeCode;
  }

  public void setOfficeCode(@Nullable String officeCode) {
    this.officeCode = officeCode;
  }

  public ClaimResponseV2 totalWarnings(@Nullable Integer totalWarnings) {
  ...
  public ClaimResponseV2 feeCalculationResponse(@Nullable FeeCalculationPatch feeCalculationResponse) {
  ...
  public ClaimResponseV2 dateSubmitted(@Nullable OffsetDateTime dateSubmitted) {
   ...
   */
  @Valid 
  @Schema(name = "date_submitted", description = "Date and time the submission was submitted", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("date_submitted")
  public @Nullable OffsetDateTime getDateSubmitted() {
    return dateSubmitted;
  }

  public void setDateSubmitted(@Nullable OffsetDateTime dateSubmitted) {
    this.dateSubmitted = dateSubmitted;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClaimResponseV2 claimResponseV2 = (ClaimResponseV2) o;
    return Objects.equals(this.id, claimResponseV2.id) &&
        Objects.equals(this.submissionId, claimResponseV2.submissionId) &&
        Objects.equals(this.status, claimResponseV2.status) &&
        Objects.equals(this.scheduleReference, claimResponseV2.scheduleReference) &&
        Objects.equals(this.lineNumber, claimResponseV2.lineNumber) &&
        Objects.equals(this.caseReferenceNumber, claimResponseV2.caseReferenceNumber) &&
        Objects.equals(this.uniqueFileNumber, claimResponseV2.uniqueFileNumber) &&
        Objects.equals(this.caseStartDate, claimResponseV2.caseStartDate) &&
        Objects.equals(this.caseConcludedDate, claimResponseV2.caseConcludedDate) &&
        Objects.equals(this.matterTypeCode, claimResponseV2.matterTypeCode) &&
        Objects.equals(this.crimeMatterTypeCode, claimResponseV2.crimeMatterTypeCode) &&
        Objects.equals(this.feeSchemeCode, claimResponseV2.feeSchemeCode) &&
        Objects.equals(this.feeCode, claimResponseV2.feeCode) &&
        Objects.equals(this.procurementAreaCode, claimResponseV2.procurementAreaCode) &&
        Objects.equals(this.accessPointCode, claimResponseV2.accessPointCode) &&
        Objects.equals(this.deliveryLocation, claimResponseV2.deliveryLocation) &&
        Objects.equals(this.representationOrderDate, claimResponseV2.representationOrderDate) &&
        Objects.equals(this.suspectsDefendantsCount, claimResponseV2.suspectsDefendantsCount) &&
        Objects.equals(this.policeStationCourtAttendancesCount, claimResponseV2.policeStationCourtAttendancesCount) &&
        Objects.equals(this.policeStationCourtPrisonId, claimResponseV2.policeStationCourtPrisonId) &&
        Objects.equals(this.dsccNumber, claimResponseV2.dsccNumber) &&
        Objects.equals(this.maatId, claimResponseV2.maatId) &&
        Objects.equals(this.prisonLawPriorApprovalNumber, claimResponseV2.prisonLawPriorApprovalNumber) &&
        Objects.equals(this.isDutySolicitor, claimResponseV2.isDutySolicitor) &&
        Objects.equals(this.isYouthCourt, claimResponseV2.isYouthCourt) &&
        Objects.equals(this.schemeId, claimResponseV2.schemeId) &&
        Objects.equals(this.mediationSessionsCount, claimResponseV2.mediationSessionsCount) &&
        Objects.equals(this.mediationTimeMinutes, claimResponseV2.mediationTimeMinutes) &&
        Objects.equals(this.outreachLocation, claimResponseV2.outreachLocation) &&
        Objects.equals(this.referralSource, claimResponseV2.referralSource) &&
        Objects.equals(this.clientForename, claimResponseV2.clientForename) &&
        Objects.equals(this.clientSurname, claimResponseV2.clientSurname) &&
        Objects.equals(this.clientDateOfBirth, claimResponseV2.clientDateOfBirth) &&
        Objects.equals(this.uniqueClientNumber, claimResponseV2.uniqueClientNumber) &&
        Objects.equals(this.clientPostcode, claimResponseV2.clientPostcode) &&
        Objects.equals(this.genderCode, claimResponseV2.genderCode) &&
        Objects.equals(this.ethnicityCode, claimResponseV2.ethnicityCode) &&
        Objects.equals(this.disabilityCode, claimResponseV2.disabilityCode) &&
        Objects.equals(this.isLegallyAided, claimResponseV2.isLegallyAided) &&
        Objects.equals(this.clientTypeCode, claimResponseV2.clientTypeCode) &&
        Objects.equals(this.homeOfficeClientNumber, claimResponseV2.homeOfficeClientNumber) &&
        Objects.equals(this.claReferenceNumber, claimResponseV2.claReferenceNumber) &&
        Objects.equals(this.claExemptionCode, claimResponseV2.claExemptionCode) &&
        Objects.equals(this.client2Forename, claimResponseV2.client2Forename) &&
        Objects.equals(this.client2Surname, claimResponseV2.client2Surname) &&
        Objects.equals(this.client2DateOfBirth, claimResponseV2.client2DateOfBirth) &&
        Objects.equals(this.client2Ucn, claimResponseV2.client2Ucn) &&
        Objects.equals(this.client2Postcode, claimResponseV2.client2Postcode) &&
        Objects.equals(this.client2GenderCode, claimResponseV2.client2GenderCode) &&
        Objects.equals(this.client2EthnicityCode, claimResponseV2.client2EthnicityCode) &&
        Objects.equals(this.client2DisabilityCode, claimResponseV2.client2DisabilityCode) &&
        Objects.equals(this.client2IsLegallyAided, claimResponseV2.client2IsLegallyAided) &&
        Objects.equals(this.caseId, claimResponseV2.caseId) &&
        Objects.equals(this.uniqueCaseId, claimResponseV2.uniqueCaseId) &&
        Objects.equals(this.caseStageCode, claimResponseV2.caseStageCode) &&
        Objects.equals(this.stageReachedCode, claimResponseV2.stageReachedCode) &&
        Objects.equals(this.standardFeeCategoryCode, claimResponseV2.standardFeeCategoryCode) &&
        Objects.equals(this.outcomeCode, claimResponseV2.outcomeCode) &&
        Objects.equals(this.designatedAccreditedRepresentativeCode, claimResponseV2.designatedAccreditedRepresentativeCode) &&
        Objects.equals(this.isPostalApplicationAccepted, claimResponseV2.isPostalApplicationAccepted) &&
        Objects.equals(this.isClient2PostalApplicationAccepted, claimResponseV2.isClient2PostalApplicationAccepted) &&
        Objects.equals(this.mentalHealthTribunalReference, claimResponseV2.mentalHealthTribunalReference) &&
        Objects.equals(this.isNrmAdvice, claimResponseV2.isNrmAdvice) &&
        Objects.equals(this.followOnWork, claimResponseV2.followOnWork) &&
        Objects.equals(this.transferDate, claimResponseV2.transferDate) &&
        Objects.equals(this.exemptionCriteriaSatisfied, claimResponseV2.exemptionCriteriaSatisfied) &&
        Objects.equals(this.exceptionalCaseFundingReference, claimResponseV2.exceptionalCaseFundingReference) &&
        Objects.equals(this.isLegacyCase, claimResponseV2.isLegacyCase) &&
        Objects.equals(this.adviceTime, claimResponseV2.adviceTime) &&
        Objects.equals(this.travelTime, claimResponseV2.travelTime) &&
        Objects.equals(this.waitingTime, claimResponseV2.waitingTime) &&
        Objects.equals(this.netProfitCostsAmount, claimResponseV2.netProfitCostsAmount) &&
        Objects.equals(this.netDisbursementAmount, claimResponseV2.netDisbursementAmount) &&
        Objects.equals(this.netCounselCostsAmount, claimResponseV2.netCounselCostsAmount) &&
        Objects.equals(this.disbursementsVatAmount, claimResponseV2.disbursementsVatAmount) &&
        Objects.equals(this.travelWaitingCostsAmount, claimResponseV2.travelWaitingCostsAmount) &&
        Objects.equals(this.netWaitingCostsAmount, claimResponseV2.netWaitingCostsAmount) &&
        Objects.equals(this.isVatApplicable, claimResponseV2.isVatApplicable) &&
        Objects.equals(this.isToleranceApplicable, claimResponseV2.isToleranceApplicable) &&
        Objects.equals(this.priorAuthorityReference, claimResponseV2.priorAuthorityReference) &&
        Objects.equals(this.isLondonRate, claimResponseV2.isLondonRate) &&
        Objects.equals(this.adjournedHearingFeeAmount, claimResponseV2.adjournedHearingFeeAmount) &&
        Objects.equals(this.isAdditionalTravelPayment, claimResponseV2.isAdditionalTravelPayment) &&
        Objects.equals(this.costsDamagesRecoveredAmount, claimResponseV2.costsDamagesRecoveredAmount) &&
        Objects.equals(this.meetingsAttendedCode, claimResponseV2.meetingsAttendedCode) &&
        Objects.equals(this.detentionTravelWaitingCostsAmount, claimResponseV2.detentionTravelWaitingCostsAmount) &&
        Objects.equals(this.jrFormFillingAmount, claimResponseV2.jrFormFillingAmount) &&
        Objects.equals(this.isEligibleClient, claimResponseV2.isEligibleClient) &&
        Objects.equals(this.courtLocationCode, claimResponseV2.courtLocationCode) &&
        Objects.equals(this.adviceTypeCode, claimResponseV2.adviceTypeCode) &&
        Objects.equals(this.medicalReportsCount, claimResponseV2.medicalReportsCount) &&
        Objects.equals(this.isIrcSurgery, claimResponseV2.isIrcSurgery) &&
        Objects.equals(this.surgeryDate, claimResponseV2.surgeryDate) &&
        Objects.equals(this.surgeryClientsCount, claimResponseV2.surgeryClientsCount) &&
        Objects.equals(this.surgeryMattersCount, claimResponseV2.surgeryMattersCount) &&
        Objects.equals(this.cmrhOralCount, claimResponseV2.cmrhOralCount) &&
        Objects.equals(this.cmrhTelephoneCount, claimResponseV2.cmrhTelephoneCount) &&
        Objects.equals(this.aitHearingCentreCode, claimResponseV2.aitHearingCentreCode) &&
        Objects.equals(this.isSubstantiveHearing, claimResponseV2.isSubstantiveHearing) &&
        Objects.equals(this.hoInterview, claimResponseV2.hoInterview) &&
        Objects.equals(this.localAuthorityNumber, claimResponseV2.localAuthorityNumber) &&
        Objects.equals(this.submissionPeriod, claimResponseV2.submissionPeriod) &&
        Objects.equals(this.createdByUserId, claimResponseV2.createdByUserId) &&
        Objects.equals(this.isAmended, claimResponseV2.isAmended) &&
        Objects.equals(this.hasAssessment, claimResponseV2.hasAssessment) &&
        Objects.equals(this.version, claimResponseV2.version) &&
        Objects.equals(this.areaOfLaw, claimResponseV2.areaOfLaw) &&
        Objects.equals(this.officeCode, claimResponseV2.officeCode) &&
        Objects.equals(this.totalWarnings, claimResponseV2.totalWarnings) &&
        Objects.equals(this.feeCalculationResponse, claimResponseV2.feeCalculationResponse) &&
        Objects.equals(this.dateSubmitted, claimResponseV2.dateSubmitted);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, submissionId, status, scheduleReference, lineNumber, caseReferenceNumber, uniqueFileNumber, caseStartDate, caseConcludedDate, matterTypeCode, crimeMatterTypeCode, feeSchemeCode, feeCode, procurementAreaCode, accessPointCode, deliveryLocation, representationOrderDate, suspectsDefendantsCount, policeStationCourtAttendancesCount, policeStationCourtPrisonId, dsccNumber, maatId, prisonLawPriorApprovalNumber, isDutySolicitor, isYouthCourt, schemeId, mediationSessionsCount, mediationTimeMinutes, outreachLocation, referralSource, clientForename, clientSurname, clientDateOfBirth, uniqueClientNumber, clientPostcode, genderCode, ethnicityCode, disabilityCode, isLegallyAided, clientTypeCode, homeOfficeClientNumber, claReferenceNumber, claExemptionCode, client2Forename, client2Surname, client2DateOfBirth, client2Ucn, client2Postcode, client2GenderCode, client2EthnicityCode, client2DisabilityCode, client2IsLegallyAided, caseId, uniqueCaseId, caseStageCode, stageReachedCode, standardFeeCategoryCode, outcomeCode, designatedAccreditedRepresentativeCode, isPostalApplicationAccepted, isClient2PostalApplicationAccepted, mentalHealthTribunalReference, isNrmAdvice, followOnWork, transferDate, exemptionCriteriaSatisfied, exceptionalCaseFundingReference, isLegacyCase, adviceTime, travelTime, waitingTime, netProfitCostsAmount, netDisbursementAmount, netCounselCostsAmount, disbursementsVatAmount, travelWaitingCostsAmount, netWaitingCostsAmount, isVatApplicable, isToleranceApplicable, priorAuthorityReference, isLondonRate, adjournedHearingFeeAmount, isAdditionalTravelPayment, costsDamagesRecoveredAmount, meetingsAttendedCode, detentionTravelWaitingCostsAmount, jrFormFillingAmount, isEligibleClient, courtLocationCode, adviceTypeCode, medicalReportsCount, isIrcSurgery, surgeryDate, surgeryClientsCount, surgeryMattersCount, cmrhOralCount, cmrhTelephoneCount, aitHearingCentreCode, isSubstantiveHearing, hoInterview, localAuthorityNumber, submissionPeriod, createdByUserId, isAmended, hasAssessment, version, areaOfLaw, officeCode, totalWarnings, feeCalculationResponse, dateSubmitted);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ClaimResponseV2 {\n");
  ...
  public static class Builder {
    ...
    private ClaimResponseV2 instance;

    public Builder() {
      this(new ClaimResponseV2());
    }

    protected Builder(ClaimResponseV2 instance) {
      this.instance = instance;
    }

    protected Builder copyOf(ClaimResponseV2 value) { 
      ...
      this.instance.setOfficeCode(value.officeCode);
      this.instance.setTotalWarnings(value.totalWarnings);
      this.instance.setFeeCalculationResponse(value.feeCalculationResponse);
      this.instance.setDateSubmitted(value.dateSubmitted);
      return this;
    }

    public ClaimResponseV2.Builder id(String id) {
      this.instance.id(id);
      return this;
    }
    
    public ClaimResponseV2.Builder submissionId(String submissionId) {
      this.instance.submissionId(submissionId);
      return this;
    }
    
    public ClaimResponseV2.Builder status(ClaimStatus status) {
      this.instance.status(status);
      return this;
    }
    
    public ClaimResponseV2.Builder scheduleReference(String scheduleReference) {
      this.instance.scheduleReference(scheduleReference);
      return this;
    }
    
    public ClaimResponseV2.Builder lineNumber(Integer lineNumber) {
      this.instance.lineNumber(lineNumber);
      return this;
    }
    
    public ClaimResponseV2.Builder caseReferenceNumber(String caseReferenceNumber) {
      this.instance.caseReferenceNumber(caseReferenceNumber);
      return this;
    }
    
    public ClaimResponseV2.Builder uniqueFileNumber(String uniqueFileNumber) {
      this.instance.uniqueFileNumber(uniqueFileNumber);
      return this;
    }
    
    public ClaimResponseV2.Builder caseStartDate(String caseStartDate) {
      this.instance.caseStartDate(caseStartDate);
      return this;
    }
    
    public ClaimResponseV2.Builder caseConcludedDate(String caseConcludedDate) {
      this.instance.caseConcludedDate(caseConcludedDate);
      return this;
    }
    
    public ClaimResponseV2.Builder matterTypeCode(String matterTypeCode) {
      this.instance.matterTypeCode(matterTypeCode);
      return this;
    }
    
    public ClaimResponseV2.Builder crimeMatterTypeCode(String crimeMatterTypeCode) {
      this.instance.crimeMatterTypeCode(crimeMatterTypeCode);
      return this;
    }
    
    public ClaimResponseV2.Builder feeSchemeCode(String feeSchemeCode) {
      this.instance.feeSchemeCode(feeSchemeCode);
      return this;
    }
    
    public ClaimResponseV2.Builder feeCode(String feeCode) {
      this.instance.feeCode(feeCode);
      return this;
    }
    
    public ClaimResponseV2.Builder procurementAreaCode(String procurementAreaCode) {
      this.instance.procurementAreaCode(procurementAreaCode);
      return this;
    }
    
    public ClaimResponseV2.Builder accessPointCode(String accessPointCode) {
      this.instance.accessPointCode(accessPointCode);
      return this;
    }
    
    public ClaimResponseV2.Builder deliveryLocation(String deliveryLocation) {
      this.instance.deliveryLocation(deliveryLocation);
      return this;
    }
    
    public ClaimResponseV2.Builder representationOrderDate(String representationOrderDate) {
      this.instance.representationOrderDate(representationOrderDate);
      return this;
    }
    
    public ClaimResponseV2.Builder suspectsDefendantsCount(Integer suspectsDefendantsCount) {
      this.instance.suspectsDefendantsCount(suspectsDefendantsCount);
      return this;
    }
    
    public ClaimResponseV2.Builder policeStationCourtAttendancesCount(Integer policeStationCourtAttendancesCount) {
      this.instance.policeStationCourtAttendancesCount(policeStationCourtAttendancesCount);
      return this;
    }
    
    public ClaimResponseV2.Builder policeStationCourtPrisonId(String policeStationCourtPrisonId) {
      this.instance.policeStationCourtPrisonId(policeStationCourtPrisonId);
      return this;
    }
    
    public ClaimResponseV2.Builder dsccNumber(String dsccNumber) {
      this.instance.dsccNumber(dsccNumber);
      return this;
    }
    
    public ClaimResponseV2.Builder maatId(String maatId) {
      this.instance.maatId(maatId);
      return this;
    }
    
    public ClaimResponseV2.Builder prisonLawPriorApprovalNumber(String prisonLawPriorApprovalNumber) {
      this.instance.prisonLawPriorApprovalNumber(prisonLawPriorApprovalNumber);
      return this;
    }
    
    public ClaimResponseV2.Builder isDutySolicitor(Boolean isDutySolicitor) {
      this.instance.isDutySolicitor(isDutySolicitor);
      return this;
    }
    
    public ClaimResponseV2.Builder isYouthCourt(Boolean isYouthCourt) {
      this.instance.isYouthCourt(isYouthCourt);
      return this;
    }
    
    public ClaimResponseV2.Builder schemeId(String schemeId) {
      this.instance.schemeId(schemeId);
      return this;
    }
    
    public ClaimResponseV2.Builder mediationSessionsCount(Integer mediationSessionsCount) {
      this.instance.mediationSessionsCount(mediationSessionsCount);
      return this;
    }
    
    public ClaimResponseV2.Builder mediationTimeMinutes(Integer mediationTimeMinutes) {
      this.instance.mediationTimeMinutes(mediationTimeMinutes);
      return this;
    }
    
    public ClaimResponseV2.Builder outreachLocation(String outreachLocation) {
      this.instance.outreachLocation(outreachLocation);
      return this;
    }
    
    public ClaimResponseV2.Builder referralSource(String referralSource) {
      this.instance.referralSource(referralSource);
      return this;
    }
    
    public ClaimResponseV2.Builder clientForename(String clientForename) {
      this.instance.clientForename(clientForename);
      return this;
    }
    
    public ClaimResponseV2.Builder clientSurname(String clientSurname) {
      this.instance.clientSurname(clientSurname);
      return this;
    }
    
    public ClaimResponseV2.Builder clientDateOfBirth(String clientDateOfBirth) {
      this.instance.clientDateOfBirth(clientDateOfBirth);
      return this;
    }
    
    public ClaimResponseV2.Builder uniqueClientNumber(String uniqueClientNumber) {
      this.instance.uniqueClientNumber(uniqueClientNumber);
      return this;
    }
    
    public ClaimResponseV2.Builder clientPostcode(String clientPostcode) {
      this.instance.clientPostcode(clientPostcode);
      return this;
    }
    
    public ClaimResponseV2.Builder genderCode(String genderCode) {
      this.instance.genderCode(genderCode);
      return this;
    }
    
    public ClaimResponseV2.Builder ethnicityCode(String ethnicityCode) {
      this.instance.ethnicityCode(ethnicityCode);
      return this;
    }
    
    public ClaimResponseV2.Builder disabilityCode(String disabilityCode) {
      this.instance.disabilityCode(disabilityCode);
      return this;
    }
    
    public ClaimResponseV2.Builder isLegallyAided(Boolean isLegallyAided) {
      this.instance.isLegallyAided(isLegallyAided);
      return this;
    }
    
    public ClaimResponseV2.Builder clientTypeCode(String clientTypeCode) {
      this.instance.clientTypeCode(clientTypeCode);
      return this;
    }
    
    public ClaimResponseV2.Builder homeOfficeClientNumber(String homeOfficeClientNumber) {
      this.instance.homeOfficeClientNumber(homeOfficeClientNumber);
      return this;
    }
    
    public ClaimResponseV2.Builder claReferenceNumber(String claReferenceNumber) {
      this.instance.claReferenceNumber(claReferenceNumber);
      return this;
    }
    
    public ClaimResponseV2.Builder claExemptionCode(String claExemptionCode) {
      this.instance.claExemptionCode(claExemptionCode);
      return this;
    }
    
    public ClaimResponseV2.Builder client2Forename(String client2Forename) {
      this.instance.client2Forename(client2Forename);
      return this;
    }
    
    public ClaimResponseV2.Builder client2Surname(String client2Surname) {
      this.instance.client2Surname(client2Surname);
      return this;
    }
    
    public ClaimResponseV2.Builder client2DateOfBirth(String client2DateOfBirth) {
      this.instance.client2DateOfBirth(client2DateOfBirth);
      return this;
    }
    
    public ClaimResponseV2.Builder client2Ucn(String client2Ucn) {
      this.instance.client2Ucn(client2Ucn);
      return this;
    }
    
    public ClaimResponseV2.Builder client2Postcode(String client2Postcode) {
      this.instance.client2Postcode(client2Postcode);
      return this;
    }
    
    public ClaimResponseV2.Builder client2GenderCode(String client2GenderCode) {
      this.instance.client2GenderCode(client2GenderCode);
      return this;
    }
    
    public ClaimResponseV2.Builder client2EthnicityCode(String client2EthnicityCode) {
      this.instance.client2EthnicityCode(client2EthnicityCode);
      return this;
    }
    
    public ClaimResponseV2.Builder client2DisabilityCode(String client2DisabilityCode) {
      this.instance.client2DisabilityCode(client2DisabilityCode);
      return this;
    }
    
    public ClaimResponseV2.Builder client2IsLegallyAided(Boolean client2IsLegallyAided) {
      this.instance.client2IsLegallyAided(client2IsLegallyAided);
      return this;
    }
    
    public ClaimResponseV2.Builder caseId(String caseId) {
      this.instance.caseId(caseId);
      return this;
    }
    
    public ClaimResponseV2.Builder uniqueCaseId(String uniqueCaseId) {
      this.instance.uniqueCaseId(uniqueCaseId);
      return this;
    }
    
    public ClaimResponseV2.Builder caseStageCode(String caseStageCode) {
      this.instance.caseStageCode(caseStageCode);
      return this;
    }
    
    public ClaimResponseV2.Builder stageReachedCode(String stageReachedCode) {
      this.instance.stageReachedCode(stageReachedCode);
      return this;
    }
    
    public ClaimResponseV2.Builder standardFeeCategoryCode(String standardFeeCategoryCode) {
      this.instance.standardFeeCategoryCode(standardFeeCategoryCode);
      return this;
    }
    
    public ClaimResponseV2.Builder outcomeCode(String outcomeCode) {
      this.instance.outcomeCode(outcomeCode);
      return this;
    }
    
    public ClaimResponseV2.Builder designatedAccreditedRepresentativeCode(String designatedAccreditedRepresentativeCode) {
      this.instance.designatedAccreditedRepresentativeCode(designatedAccreditedRepresentativeCode);
      return this;
    }
    
    public ClaimResponseV2.Builder isPostalApplicationAccepted(Boolean isPostalApplicationAccepted) {
      this.instance.isPostalApplicationAccepted(isPostalApplicationAccepted);
      return this;
    }
    
    public ClaimResponseV2.Builder isClient2PostalApplicationAccepted(Boolean isClient2PostalApplicationAccepted) {
      this.instance.isClient2PostalApplicationAccepted(isClient2PostalApplicationAccepted);
      return this;
    }
    
    public ClaimResponseV2.Builder mentalHealthTribunalReference(String mentalHealthTribunalReference) {
      this.instance.mentalHealthTribunalReference(mentalHealthTribunalReference);
      return this;
    }
    
    public ClaimResponseV2.Builder isNrmAdvice(Boolean isNrmAdvice) {
      this.instance.isNrmAdvice(isNrmAdvice);
      return this;
    }
    
    public ClaimResponseV2.Builder followOnWork(String followOnWork) {
      this.instance.followOnWork(followOnWork);
      return this;
    }
    
    public ClaimResponseV2.Builder transferDate(String transferDate) {
      this.instance.transferDate(transferDate);
      return this;
    }
    
    public ClaimResponseV2.Builder exemptionCriteriaSatisfied(String exemptionCriteriaSatisfied) {
      this.instance.exemptionCriteriaSatisfied(exemptionCriteriaSatisfied);
      return this;
    }
    
    public ClaimResponseV2.Builder exceptionalCaseFundingReference(String exceptionalCaseFundingReference) {
      this.instance.exceptionalCaseFundingReference(exceptionalCaseFundingReference);
      return this;
    }
    
    public ClaimResponseV2.Builder isLegacyCase(Boolean isLegacyCase) {
      this.instance.isLegacyCase(isLegacyCase);
      return this;
    }
    
    public ClaimResponseV2.Builder adviceTime(Integer adviceTime) {
      this.instance.adviceTime(adviceTime);
      return this;
    }
    
    public ClaimResponseV2.Builder travelTime(Integer travelTime) {
      this.instance.travelTime(travelTime);
      return this;
    }
    
    public ClaimResponseV2.Builder waitingTime(Integer waitingTime) {
      this.instance.waitingTime(waitingTime);
      return this;
    }
    
    public ClaimResponseV2.Builder netProfitCostsAmount(BigDecimal netProfitCostsAmount) {
      this.instance.netProfitCostsAmount(netProfitCostsAmount);
      return this;
    }
    
    public ClaimResponseV2.Builder netDisbursementAmount(BigDecimal netDisbursementAmount) {
      this.instance.netDisbursementAmount(netDisbursementAmount);
      return this;
    }
    
    public ClaimResponseV2.Builder netCounselCostsAmount(BigDecimal netCounselCostsAmount) {
      this.instance.netCounselCostsAmount(netCounselCostsAmount);
      return this;
    }
    
    public ClaimResponseV2.Builder disbursementsVatAmount(BigDecimal disbursementsVatAmount) {
      this.instance.disbursementsVatAmount(disbursementsVatAmount);
      return this;
    }
    
    public ClaimResponseV2.Builder travelWaitingCostsAmount(BigDecimal travelWaitingCostsAmount) {
      this.instance.travelWaitingCostsAmount(travelWaitingCostsAmount);
      return this;
    }
    
    public ClaimResponseV2.Builder netWaitingCostsAmount(BigDecimal netWaitingCostsAmount) {
      this.instance.netWaitingCostsAmount(netWaitingCostsAmount);
      return this;
    }
    
    public ClaimResponseV2.Builder isVatApplicable(Boolean isVatApplicable) {
      this.instance.isVatApplicable(isVatApplicable);
      return this;
    }
    
    public ClaimResponseV2.Builder isToleranceApplicable(Boolean isToleranceApplicable) {
      this.instance.isToleranceApplicable(isToleranceApplicable);
      return this;
    }
    
    public ClaimResponseV2.Builder priorAuthorityReference(String priorAuthorityReference) {
      this.instance.priorAuthorityReference(priorAuthorityReference);
      return this;
    }
    
    public ClaimResponseV2.Builder isLondonRate(Boolean isLondonRate) {
      this.instance.isLondonRate(isLondonRate);
      return this;
    }
    
    public ClaimResponseV2.Builder adjournedHearingFeeAmount(Integer adjournedHearingFeeAmount) {
      this.instance.adjournedHearingFeeAmount(adjournedHearingFeeAmount);
      return this;
    }
    
    public ClaimResponseV2.Builder isAdditionalTravelPayment(Boolean isAdditionalTravelPayment) {
      this.instance.isAdditionalTravelPayment(isAdditionalTravelPayment);
      return this;
    }
    
    public ClaimResponseV2.Builder costsDamagesRecoveredAmount(BigDecimal costsDamagesRecoveredAmount) {
      this.instance.costsDamagesRecoveredAmount(costsDamagesRecoveredAmount);
      return this;
    }
    
    public ClaimResponseV2.Builder meetingsAttendedCode(String meetingsAttendedCode) {
      this.instance.meetingsAttendedCode(meetingsAttendedCode);
      return this;
    }
    
    public ClaimResponseV2.Builder detentionTravelWaitingCostsAmount(BigDecimal detentionTravelWaitingCostsAmount) {
      this.instance.detentionTravelWaitingCostsAmount(detentionTravelWaitingCostsAmount);
      return this;
    }
    
    public ClaimResponseV2.Builder jrFormFillingAmount(BigDecimal jrFormFillingAmount) {
      this.instance.jrFormFillingAmount(jrFormFillingAmount);
      return this;
    }
    
    public ClaimResponseV2.Builder isEligibleClient(Boolean isEligibleClient) {
      this.instance.isEligibleClient(isEligibleClient);
      return this;
    }
    
    public ClaimResponseV2.Builder courtLocationCode(String courtLocationCode) {
      this.instance.courtLocationCode(courtLocationCode);
      return this;
    }
    
    public ClaimResponseV2.Builder adviceTypeCode(String adviceTypeCode) {
      this.instance.adviceTypeCode(adviceTypeCode);
      return this;
    }
    
    public ClaimResponseV2.Builder medicalReportsCount(Integer medicalReportsCount) {
      this.instance.medicalReportsCount(medicalReportsCount);
      return this;
    }
    
    public ClaimResponseV2.Builder isIrcSurgery(Boolean isIrcSurgery) {
      this.instance.isIrcSurgery(isIrcSurgery);
      return this;
    }
    
    public ClaimResponseV2.Builder surgeryDate(String surgeryDate) {
      this.instance.surgeryDate(surgeryDate);
      return this;
    }
    
    public ClaimResponseV2.Builder surgeryClientsCount(Integer surgeryClientsCount) {
      this.instance.surgeryClientsCount(surgeryClientsCount);
      return this;
    }
    
    public ClaimResponseV2.Builder surgeryMattersCount(Integer surgeryMattersCount) {
      this.instance.surgeryMattersCount(surgeryMattersCount);
      return this;
    }
    
    public ClaimResponseV2.Builder cmrhOralCount(Integer cmrhOralCount) {
      this.instance.cmrhOralCount(cmrhOralCount);
      return this;
    }
    
    public ClaimResponseV2.Builder cmrhTelephoneCount(Integer cmrhTelephoneCount) {
      this.instance.cmrhTelephoneCount(cmrhTelephoneCount);
      return this;
    }
    
    public ClaimResponseV2.Builder aitHearingCentreCode(String aitHearingCentreCode) {
      this.instance.aitHearingCentreCode(aitHearingCentreCode);
      return this;
    }
    
    public ClaimResponseV2.Builder isSubstantiveHearing(Boolean isSubstantiveHearing) {
      this.instance.isSubstantiveHearing(isSubstantiveHearing);
      return this;
    }
    
    public ClaimResponseV2.Builder hoInterview(Integer hoInterview) {
      this.instance.hoInterview(hoInterview);
      return this;
    }
    
    public ClaimResponseV2.Builder localAuthorityNumber(String localAuthorityNumber) {
      this.instance.localAuthorityNumber(localAuthorityNumber);
      return this;
    }
    
    public ClaimResponseV2.Builder submissionPeriod(String submissionPeriod) {
      this.instance.submissionPeriod(submissionPeriod);
      return this;
    }
    
    public ClaimResponseV2.Builder createdByUserId(String createdByUserId) {
      this.instance.createdByUserId(createdByUserId);
      return this;
    }
    
    public ClaimResponseV2.Builder isAmended(Boolean isAmended) {
      this.instance.isAmended(isAmended);
      return this;
    }
    
    public ClaimResponseV2.Builder hasAssessment(Boolean hasAssessment) {
      this.instance.hasAssessment(hasAssessment);
      return this;
    }
    
    public ClaimResponseV2.Builder version(Long version) {
      this.instance.version(version);
      return this;
    }
    
    public ClaimResponseV2.Builder areaOfLaw(AreaOfLaw areaOfLaw) {
      this.instance.areaOfLaw(areaOfLaw);
      return this;
    }
    
    public ClaimResponseV2.Builder officeCode(String officeCode) {
      this.instance.officeCode(officeCode);
      return this;
    }
    
    public ClaimResponseV2.Builder totalWarnings(Integer totalWarnings) {
      this.instance.totalWarnings(totalWarnings);
      return this;
    }
    
    public ClaimResponseV2.Builder feeCalculationResponse(FeeCalculationPatch feeCalculationResponse) {
      this.instance.feeCalculationResponse(feeCalculationResponse);
      return this;
    }
    
    public ClaimResponseV2.Builder dateSubmitted(OffsetDateTime dateSubmitted) {
      this.instance.dateSubmitted(dateSubmitted);
      return this;
    }
    
    /**
    * returns a built ClaimResponseV2 instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public ClaimResponseV2 build() {
      try {
  ...
  */
  public static ClaimResponseV2.Builder builder() {
    return new ClaimResponseV2.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public ClaimResponseV2.Builder toBuilder() {
    ClaimResponseV2.Builder builder = new ClaimResponseV2.Builder();
