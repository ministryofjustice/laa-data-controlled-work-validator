...
public class ClaimPost implements Serializable {
   ...
   */
  public ClaimPost(ClaimStatus status, Integer lineNumber, String matterTypeCode, String createdByUserId) {
    this.status = status;
  ...
  public ClaimPost id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ClaimPost submissionId(@Nullable String submissionId) {
  ...
  public ClaimPost status(ClaimStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ClaimPost scheduleReference(@Nullable String scheduleReference) {
  ...
  public ClaimPost lineNumber(Integer lineNumber) {
    this.lineNumber = lineNumber;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "line_number", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public ClaimPost caseReferenceNumber(@Nullable String caseReferenceNumber) {
  ...
  public ClaimPost uniqueFileNumber(@Nullable String uniqueFileNumber) {
  ...
  public ClaimPost caseStartDate(@Nullable String caseStartDate) {
  ...
  public ClaimPost caseConcludedDate(@Nullable String caseConcludedDate) {
  ...
  public ClaimPost matterTypeCode(String matterTypeCode) {
    this.matterTypeCode = matterTypeCode;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "matter_type_code", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public ClaimPost crimeMatterTypeCode(@Nullable String crimeMatterTypeCode) {
  ...
  public ClaimPost feeSchemeCode(@Nullable String feeSchemeCode) {
  ...
  public ClaimPost feeCode(@Nullable String feeCode) {
  ...
  public ClaimPost procurementAreaCode(@Nullable String procurementAreaCode) {
  ...
  public ClaimPost accessPointCode(@Nullable String accessPointCode) {
  ...
  public ClaimPost deliveryLocation(@Nullable String deliveryLocation) {
  ...
  public ClaimPost representationOrderDate(@Nullable String representationOrderDate) {
  ...
  public ClaimPost suspectsDefendantsCount(@Nullable Integer suspectsDefendantsCount) {
  ...
  public ClaimPost policeStationCourtAttendancesCount(@Nullable Integer policeStationCourtAttendancesCount) {
  ...
  public ClaimPost policeStationCourtPrisonId(@Nullable String policeStationCourtPrisonId) {
  ...
  public ClaimPost dsccNumber(@Nullable String dsccNumber) {
  ...
  public ClaimPost maatId(@Nullable String maatId) {
    this.maatId = maatId;
    return this;
  }
  ...
  public ClaimPost prisonLawPriorApprovalNumber(@Nullable String prisonLawPriorApprovalNumber) {
  ...
  public ClaimPost isDutySolicitor(@Nullable Boolean isDutySolicitor) {
  ...
  public ClaimPost isYouthCourt(@Nullable Boolean isYouthCourt) {
  ...
  public ClaimPost schemeId(@Nullable String schemeId) {
  ...
  public ClaimPost mediationSessionsCount(@Nullable Integer mediationSessionsCount) {
  ...
  public ClaimPost mediationTimeMinutes(@Nullable Integer mediationTimeMinutes) {
  ...
  public ClaimPost outreachLocation(@Nullable String outreachLocation) {
  ...
  public ClaimPost referralSource(@Nullable String referralSource) {
  ...
  public ClaimPost clientForename(@Nullable String clientForename) {
  ...
  public ClaimPost clientSurname(@Nullable String clientSurname) {
  ...
  public ClaimPost clientDateOfBirth(@Nullable String clientDateOfBirth) {
  ...
  public ClaimPost uniqueClientNumber(@Nullable String uniqueClientNumber) {
  ...
  public ClaimPost clientPostcode(@Nullable String clientPostcode) {
  ...
  public ClaimPost genderCode(@Nullable String genderCode) {
  ...
  public ClaimPost ethnicityCode(@Nullable String ethnicityCode) {
  ...
  public ClaimPost disabilityCode(@Nullable String disabilityCode) {
  ...
  public ClaimPost isLegallyAided(@Nullable Boolean isLegallyAided) {
  ...
  public ClaimPost clientTypeCode(@Nullable String clientTypeCode) {
  ...
  public ClaimPost homeOfficeClientNumber(@Nullable String homeOfficeClientNumber) {
  ...
  public ClaimPost claReferenceNumber(@Nullable String claReferenceNumber) {
  ...
  public ClaimPost claExemptionCode(@Nullable String claExemptionCode) {
  ...
  public ClaimPost client2Forename(@Nullable String client2Forename) {
  ...
  public ClaimPost client2Surname(@Nullable String client2Surname) {
  ...
  public ClaimPost client2DateOfBirth(@Nullable String client2DateOfBirth) {
  ...
  public ClaimPost client2Ucn(@Nullable String client2Ucn) {
  ...
  public ClaimPost client2Postcode(@Nullable String client2Postcode) {
  ...
  public ClaimPost client2GenderCode(@Nullable String client2GenderCode) {
  ...
  public ClaimPost client2EthnicityCode(@Nullable String client2EthnicityCode) {
  ...
  public ClaimPost client2DisabilityCode(@Nullable String client2DisabilityCode) {
  ...
  public ClaimPost client2IsLegallyAided(@Nullable Boolean client2IsLegallyAided) {
  ...
  public ClaimPost caseId(@Nullable String caseId) {
    this.caseId = caseId;
    return this;
  }
  ...
  public ClaimPost uniqueCaseId(@Nullable String uniqueCaseId) {
  ...
  public ClaimPost caseStageCode(@Nullable String caseStageCode) {
  ...
  public ClaimPost stageReachedCode(@Nullable String stageReachedCode) {
  ...
  public ClaimPost standardFeeCategoryCode(@Nullable String standardFeeCategoryCode) {
  ...
  public ClaimPost outcomeCode(@Nullable String outcomeCode) {
  ...
  public ClaimPost designatedAccreditedRepresentativeCode(@Nullable String designatedAccreditedRepresentativeCode) {
  ...
  public ClaimPost isPostalApplicationAccepted(@Nullable Boolean isPostalApplicationAccepted) {
  ...
  public ClaimPost isClient2PostalApplicationAccepted(@Nullable Boolean isClient2PostalApplicationAccepted) {
  ...
  public ClaimPost mentalHealthTribunalReference(@Nullable String mentalHealthTribunalReference) {
  ...
  public ClaimPost isNrmAdvice(@Nullable Boolean isNrmAdvice) {
  ...
  public ClaimPost followOnWork(@Nullable String followOnWork) {
  ...
  public ClaimPost transferDate(@Nullable String transferDate) {
  ...
  public ClaimPost exemptionCriteriaSatisfied(@Nullable String exemptionCriteriaSatisfied) {
  ...
  public ClaimPost exceptionalCaseFundingReference(@Nullable String exceptionalCaseFundingReference) {
  ...
  public ClaimPost isLegacyCase(@Nullable Boolean isLegacyCase) {
  ...
  public ClaimPost adviceTime(@Nullable Integer adviceTime) {
  ...
  public ClaimPost travelTime(@Nullable Integer travelTime) {
  ...
  public ClaimPost waitingTime(@Nullable Integer waitingTime) {
  ...
  public ClaimPost netProfitCostsAmount(@Nullable BigDecimal netProfitCostsAmount) {
  ...
  public ClaimPost netDisbursementAmount(@Nullable BigDecimal netDisbursementAmount) {
  ...
  public ClaimPost netCounselCostsAmount(@Nullable BigDecimal netCounselCostsAmount) {
  ...
  public ClaimPost disbursementsVatAmount(@Nullable BigDecimal disbursementsVatAmount) {
  ...
  public ClaimPost travelWaitingCostsAmount(@Nullable BigDecimal travelWaitingCostsAmount) {
  ...
  public ClaimPost netWaitingCostsAmount(@Nullable BigDecimal netWaitingCostsAmount) {
  ...
  public ClaimPost isVatApplicable(@Nullable Boolean isVatApplicable) {
  ...
  public ClaimPost isToleranceApplicable(@Nullable Boolean isToleranceApplicable) {
  ...
  public ClaimPost priorAuthorityReference(@Nullable String priorAuthorityReference) {
  ...
  public ClaimPost isLondonRate(@Nullable Boolean isLondonRate) {
  ...
  public ClaimPost adjournedHearingFeeAmount(@Nullable Integer adjournedHearingFeeAmount) {
  ...
  public ClaimPost isAdditionalTravelPayment(@Nullable Boolean isAdditionalTravelPayment) {
  ...
  public ClaimPost costsDamagesRecoveredAmount(@Nullable BigDecimal costsDamagesRecoveredAmount) {
  ...
  public ClaimPost meetingsAttendedCode(@Nullable String meetingsAttendedCode) {
  ...
  public ClaimPost detentionTravelWaitingCostsAmount(@Nullable BigDecimal detentionTravelWaitingCostsAmount) {
  ...
  public ClaimPost jrFormFillingAmount(@Nullable BigDecimal jrFormFillingAmount) {
  ...
  public ClaimPost isEligibleClient(@Nullable Boolean isEligibleClient) {
  ...
  public ClaimPost courtLocationCode(@Nullable String courtLocationCode) {
  ...
  public ClaimPost adviceTypeCode(@Nullable String adviceTypeCode) {
  ...
  public ClaimPost medicalReportsCount(@Nullable Integer medicalReportsCount) {
  ...
  public ClaimPost isIrcSurgery(@Nullable Boolean isIrcSurgery) {
  ...
  public ClaimPost surgeryDate(@Nullable String surgeryDate) {
  ...
  public ClaimPost surgeryClientsCount(@Nullable Integer surgeryClientsCount) {
  ...
  public ClaimPost surgeryMattersCount(@Nullable Integer surgeryMattersCount) {
  ...
  public ClaimPost cmrhOralCount(@Nullable Integer cmrhOralCount) {
  ...
  public ClaimPost cmrhTelephoneCount(@Nullable Integer cmrhTelephoneCount) {
  ...
  public ClaimPost aitHearingCentreCode(@Nullable String aitHearingCentreCode) {
  ...
  public ClaimPost isSubstantiveHearing(@Nullable Boolean isSubstantiveHearing) {
  ...
  public ClaimPost hoInterview(@Nullable Integer hoInterview) {
  ...
  public ClaimPost localAuthorityNumber(@Nullable String localAuthorityNumber) {
  ...
  public ClaimPost submissionPeriod(@Nullable String submissionPeriod) {
  ...
  public ClaimPost createdByUserId(String createdByUserId) {
    this.createdByUserId = createdByUserId;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "created_by_user_id", description = "The id of the user who created the claim.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public ClaimPost isAmended(@Nullable Boolean isAmended) {
  ...
  public ClaimPost hasAssessment(@Nullable Boolean hasAssessment) {
  ...
  public ClaimPost version(@Nullable Long version) {
  ...
  public boolean equals(Object o) {
    ...
    ClaimPost claimPost = (ClaimPost) o;
    return Objects.equals(this.id, claimPost.id) &&
        Objects.equals(this.submissionId, claimPost.submissionId) &&
        Objects.equals(this.status, claimPost.status) &&
        Objects.equals(this.scheduleReference, claimPost.scheduleReference) &&
        Objects.equals(this.lineNumber, claimPost.lineNumber) &&
        Objects.equals(this.caseReferenceNumber, claimPost.caseReferenceNumber) &&
        Objects.equals(this.uniqueFileNumber, claimPost.uniqueFileNumber) &&
        Objects.equals(this.caseStartDate, claimPost.caseStartDate) &&
        Objects.equals(this.caseConcludedDate, claimPost.caseConcludedDate) &&
        Objects.equals(this.matterTypeCode, claimPost.matterTypeCode) &&
        Objects.equals(this.crimeMatterTypeCode, claimPost.crimeMatterTypeCode) &&
        Objects.equals(this.feeSchemeCode, claimPost.feeSchemeCode) &&
        Objects.equals(this.feeCode, claimPost.feeCode) &&
        Objects.equals(this.procurementAreaCode, claimPost.procurementAreaCode) &&
        Objects.equals(this.accessPointCode, claimPost.accessPointCode) &&
        Objects.equals(this.deliveryLocation, claimPost.deliveryLocation) &&
        Objects.equals(this.representationOrderDate, claimPost.representationOrderDate) &&
        Objects.equals(this.suspectsDefendantsCount, claimPost.suspectsDefendantsCount) &&
        Objects.equals(this.policeStationCourtAttendancesCount, claimPost.policeStationCourtAttendancesCount) &&
        Objects.equals(this.policeStationCourtPrisonId, claimPost.policeStationCourtPrisonId) &&
        Objects.equals(this.dsccNumber, claimPost.dsccNumber) &&
        Objects.equals(this.maatId, claimPost.maatId) &&
        Objects.equals(this.prisonLawPriorApprovalNumber, claimPost.prisonLawPriorApprovalNumber) &&
        Objects.equals(this.isDutySolicitor, claimPost.isDutySolicitor) &&
        Objects.equals(this.isYouthCourt, claimPost.isYouthCourt) &&
        Objects.equals(this.schemeId, claimPost.schemeId) &&
        Objects.equals(this.mediationSessionsCount, claimPost.mediationSessionsCount) &&
        Objects.equals(this.mediationTimeMinutes, claimPost.mediationTimeMinutes) &&
        Objects.equals(this.outreachLocation, claimPost.outreachLocation) &&
        Objects.equals(this.referralSource, claimPost.referralSource) &&
        Objects.equals(this.clientForename, claimPost.clientForename) &&
        Objects.equals(this.clientSurname, claimPost.clientSurname) &&
        Objects.equals(this.clientDateOfBirth, claimPost.clientDateOfBirth) &&
        Objects.equals(this.uniqueClientNumber, claimPost.uniqueClientNumber) &&
        Objects.equals(this.clientPostcode, claimPost.clientPostcode) &&
        Objects.equals(this.genderCode, claimPost.genderCode) &&
        Objects.equals(this.ethnicityCode, claimPost.ethnicityCode) &&
        Objects.equals(this.disabilityCode, claimPost.disabilityCode) &&
        Objects.equals(this.isLegallyAided, claimPost.isLegallyAided) &&
        Objects.equals(this.clientTypeCode, claimPost.clientTypeCode) &&
        Objects.equals(this.homeOfficeClientNumber, claimPost.homeOfficeClientNumber) &&
        Objects.equals(this.claReferenceNumber, claimPost.claReferenceNumber) &&
        Objects.equals(this.claExemptionCode, claimPost.claExemptionCode) &&
        Objects.equals(this.client2Forename, claimPost.client2Forename) &&
        Objects.equals(this.client2Surname, claimPost.client2Surname) &&
        Objects.equals(this.client2DateOfBirth, claimPost.client2DateOfBirth) &&
        Objects.equals(this.client2Ucn, claimPost.client2Ucn) &&
        Objects.equals(this.client2Postcode, claimPost.client2Postcode) &&
        Objects.equals(this.client2GenderCode, claimPost.client2GenderCode) &&
        Objects.equals(this.client2EthnicityCode, claimPost.client2EthnicityCode) &&
        Objects.equals(this.client2DisabilityCode, claimPost.client2DisabilityCode) &&
        Objects.equals(this.client2IsLegallyAided, claimPost.client2IsLegallyAided) &&
        Objects.equals(this.caseId, claimPost.caseId) &&
        Objects.equals(this.uniqueCaseId, claimPost.uniqueCaseId) &&
        Objects.equals(this.caseStageCode, claimPost.caseStageCode) &&
        Objects.equals(this.stageReachedCode, claimPost.stageReachedCode) &&
        Objects.equals(this.standardFeeCategoryCode, claimPost.standardFeeCategoryCode) &&
        Objects.equals(this.outcomeCode, claimPost.outcomeCode) &&
        Objects.equals(this.designatedAccreditedRepresentativeCode, claimPost.designatedAccreditedRepresentativeCode) &&
        Objects.equals(this.isPostalApplicationAccepted, claimPost.isPostalApplicationAccepted) &&
        Objects.equals(this.isClient2PostalApplicationAccepted, claimPost.isClient2PostalApplicationAccepted) &&
        Objects.equals(this.mentalHealthTribunalReference, claimPost.mentalHealthTribunalReference) &&
        Objects.equals(this.isNrmAdvice, claimPost.isNrmAdvice) &&
        Objects.equals(this.followOnWork, claimPost.followOnWork) &&
        Objects.equals(this.transferDate, claimPost.transferDate) &&
        Objects.equals(this.exemptionCriteriaSatisfied, claimPost.exemptionCriteriaSatisfied) &&
        Objects.equals(this.exceptionalCaseFundingReference, claimPost.exceptionalCaseFundingReference) &&
        Objects.equals(this.isLegacyCase, claimPost.isLegacyCase) &&
        Objects.equals(this.adviceTime, claimPost.adviceTime) &&
        Objects.equals(this.travelTime, claimPost.travelTime) &&
        Objects.equals(this.waitingTime, claimPost.waitingTime) &&
        Objects.equals(this.netProfitCostsAmount, claimPost.netProfitCostsAmount) &&
        Objects.equals(this.netDisbursementAmount, claimPost.netDisbursementAmount) &&
        Objects.equals(this.netCounselCostsAmount, claimPost.netCounselCostsAmount) &&
        Objects.equals(this.disbursementsVatAmount, claimPost.disbursementsVatAmount) &&
        Objects.equals(this.travelWaitingCostsAmount, claimPost.travelWaitingCostsAmount) &&
        Objects.equals(this.netWaitingCostsAmount, claimPost.netWaitingCostsAmount) &&
        Objects.equals(this.isVatApplicable, claimPost.isVatApplicable) &&
        Objects.equals(this.isToleranceApplicable, claimPost.isToleranceApplicable) &&
        Objects.equals(this.priorAuthorityReference, claimPost.priorAuthorityReference) &&
        Objects.equals(this.isLondonRate, claimPost.isLondonRate) &&
        Objects.equals(this.adjournedHearingFeeAmount, claimPost.adjournedHearingFeeAmount) &&
        Objects.equals(this.isAdditionalTravelPayment, claimPost.isAdditionalTravelPayment) &&
        Objects.equals(this.costsDamagesRecoveredAmount, claimPost.costsDamagesRecoveredAmount) &&
        Objects.equals(this.meetingsAttendedCode, claimPost.meetingsAttendedCode) &&
        Objects.equals(this.detentionTravelWaitingCostsAmount, claimPost.detentionTravelWaitingCostsAmount) &&
        Objects.equals(this.jrFormFillingAmount, claimPost.jrFormFillingAmount) &&
        Objects.equals(this.isEligibleClient, claimPost.isEligibleClient) &&
        Objects.equals(this.courtLocationCode, claimPost.courtLocationCode) &&
        Objects.equals(this.adviceTypeCode, claimPost.adviceTypeCode) &&
        Objects.equals(this.medicalReportsCount, claimPost.medicalReportsCount) &&
        Objects.equals(this.isIrcSurgery, claimPost.isIrcSurgery) &&
        Objects.equals(this.surgeryDate, claimPost.surgeryDate) &&
        Objects.equals(this.surgeryClientsCount, claimPost.surgeryClientsCount) &&
        Objects.equals(this.surgeryMattersCount, claimPost.surgeryMattersCount) &&
        Objects.equals(this.cmrhOralCount, claimPost.cmrhOralCount) &&
        Objects.equals(this.cmrhTelephoneCount, claimPost.cmrhTelephoneCount) &&
        Objects.equals(this.aitHearingCentreCode, claimPost.aitHearingCentreCode) &&
        Objects.equals(this.isSubstantiveHearing, claimPost.isSubstantiveHearing) &&
        Objects.equals(this.hoInterview, claimPost.hoInterview) &&
        Objects.equals(this.localAuthorityNumber, claimPost.localAuthorityNumber) &&
        Objects.equals(this.submissionPeriod, claimPost.submissionPeriod) &&
        Objects.equals(this.createdByUserId, claimPost.createdByUserId) &&
        Objects.equals(this.isAmended, claimPost.isAmended) &&
        Objects.equals(this.hasAssessment, claimPost.hasAssessment) &&
        Objects.equals(this.version, claimPost.version);
  }
  ...
  public static class Builder {
    ...
    private ClaimPost instance;

    public Builder() {
      this(new ClaimPost());
    }

    protected Builder(ClaimPost instance) {
      this.instance = instance;
    }

    protected Builder copyOf(ClaimPost value) { 
    ...
    public ClaimPost.Builder id(String id) {
      this.instance.id(id);
      return this;
    }
    
    public ClaimPost.Builder submissionId(String submissionId) {
      this.instance.submissionId(submissionId);
      return this;
    }
    
    public ClaimPost.Builder status(ClaimStatus status) {
      this.instance.status(status);
      return this;
    }
    
    public ClaimPost.Builder scheduleReference(String scheduleReference) {
      this.instance.scheduleReference(scheduleReference);
      return this;
    }
    
    public ClaimPost.Builder lineNumber(Integer lineNumber) {
      this.instance.lineNumber(lineNumber);
      return this;
    }
    
    public ClaimPost.Builder caseReferenceNumber(String caseReferenceNumber) {
      this.instance.caseReferenceNumber(caseReferenceNumber);
      return this;
    }
    
    public ClaimPost.Builder uniqueFileNumber(String uniqueFileNumber) {
      this.instance.uniqueFileNumber(uniqueFileNumber);
      return this;
    }
    
    public ClaimPost.Builder caseStartDate(String caseStartDate) {
      this.instance.caseStartDate(caseStartDate);
      return this;
    }
    
    public ClaimPost.Builder caseConcludedDate(String caseConcludedDate) {
      this.instance.caseConcludedDate(caseConcludedDate);
      return this;
    }
    
    public ClaimPost.Builder matterTypeCode(String matterTypeCode) {
      this.instance.matterTypeCode(matterTypeCode);
      return this;
    }
    
    public ClaimPost.Builder crimeMatterTypeCode(String crimeMatterTypeCode) {
      this.instance.crimeMatterTypeCode(crimeMatterTypeCode);
      return this;
    }
    
    public ClaimPost.Builder feeSchemeCode(String feeSchemeCode) {
      this.instance.feeSchemeCode(feeSchemeCode);
      return this;
    }
    
    public ClaimPost.Builder feeCode(String feeCode) {
      this.instance.feeCode(feeCode);
      return this;
    }
    
    public ClaimPost.Builder procurementAreaCode(String procurementAreaCode) {
      this.instance.procurementAreaCode(procurementAreaCode);
      return this;
    }
    
    public ClaimPost.Builder accessPointCode(String accessPointCode) {
      this.instance.accessPointCode(accessPointCode);
      return this;
    }
    
    public ClaimPost.Builder deliveryLocation(String deliveryLocation) {
      this.instance.deliveryLocation(deliveryLocation);
      return this;
    }
    
    public ClaimPost.Builder representationOrderDate(String representationOrderDate) {
      this.instance.representationOrderDate(representationOrderDate);
      return this;
    }
    
    public ClaimPost.Builder suspectsDefendantsCount(Integer suspectsDefendantsCount) {
      this.instance.suspectsDefendantsCount(suspectsDefendantsCount);
      return this;
    }
    
    public ClaimPost.Builder policeStationCourtAttendancesCount(Integer policeStationCourtAttendancesCount) {
      this.instance.policeStationCourtAttendancesCount(policeStationCourtAttendancesCount);
      return this;
    }
    
    public ClaimPost.Builder policeStationCourtPrisonId(String policeStationCourtPrisonId) {
      this.instance.policeStationCourtPrisonId(policeStationCourtPrisonId);
      return this;
    }
    
    public ClaimPost.Builder dsccNumber(String dsccNumber) {
      this.instance.dsccNumber(dsccNumber);
      return this;
    }
    
    public ClaimPost.Builder maatId(String maatId) {
      this.instance.maatId(maatId);
      return this;
    }
    
    public ClaimPost.Builder prisonLawPriorApprovalNumber(String prisonLawPriorApprovalNumber) {
      this.instance.prisonLawPriorApprovalNumber(prisonLawPriorApprovalNumber);
      return this;
    }
    
    public ClaimPost.Builder isDutySolicitor(Boolean isDutySolicitor) {
      this.instance.isDutySolicitor(isDutySolicitor);
      return this;
    }
    
    public ClaimPost.Builder isYouthCourt(Boolean isYouthCourt) {
      this.instance.isYouthCourt(isYouthCourt);
      return this;
    }
    
    public ClaimPost.Builder schemeId(String schemeId) {
      this.instance.schemeId(schemeId);
      return this;
    }
    
    public ClaimPost.Builder mediationSessionsCount(Integer mediationSessionsCount) {
      this.instance.mediationSessionsCount(mediationSessionsCount);
      return this;
    }
    
    public ClaimPost.Builder mediationTimeMinutes(Integer mediationTimeMinutes) {
      this.instance.mediationTimeMinutes(mediationTimeMinutes);
      return this;
    }
    
    public ClaimPost.Builder outreachLocation(String outreachLocation) {
      this.instance.outreachLocation(outreachLocation);
      return this;
    }
    
    public ClaimPost.Builder referralSource(String referralSource) {
      this.instance.referralSource(referralSource);
      return this;
    }
    
    public ClaimPost.Builder clientForename(String clientForename) {
      this.instance.clientForename(clientForename);
      return this;
    }
    
    public ClaimPost.Builder clientSurname(String clientSurname) {
      this.instance.clientSurname(clientSurname);
      return this;
    }
    
    public ClaimPost.Builder clientDateOfBirth(String clientDateOfBirth) {
      this.instance.clientDateOfBirth(clientDateOfBirth);
      return this;
    }
    
    public ClaimPost.Builder uniqueClientNumber(String uniqueClientNumber) {
      this.instance.uniqueClientNumber(uniqueClientNumber);
      return this;
    }
    
    public ClaimPost.Builder clientPostcode(String clientPostcode) {
      this.instance.clientPostcode(clientPostcode);
      return this;
    }
    
    public ClaimPost.Builder genderCode(String genderCode) {
      this.instance.genderCode(genderCode);
      return this;
    }
    
    public ClaimPost.Builder ethnicityCode(String ethnicityCode) {
      this.instance.ethnicityCode(ethnicityCode);
      return this;
    }
    
    public ClaimPost.Builder disabilityCode(String disabilityCode) {
      this.instance.disabilityCode(disabilityCode);
      return this;
    }
    
    public ClaimPost.Builder isLegallyAided(Boolean isLegallyAided) {
      this.instance.isLegallyAided(isLegallyAided);
      return this;
    }
    
    public ClaimPost.Builder clientTypeCode(String clientTypeCode) {
      this.instance.clientTypeCode(clientTypeCode);
      return this;
    }
    
    public ClaimPost.Builder homeOfficeClientNumber(String homeOfficeClientNumber) {
      this.instance.homeOfficeClientNumber(homeOfficeClientNumber);
      return this;
    }
    
    public ClaimPost.Builder claReferenceNumber(String claReferenceNumber) {
      this.instance.claReferenceNumber(claReferenceNumber);
      return this;
    }
    
    public ClaimPost.Builder claExemptionCode(String claExemptionCode) {
      this.instance.claExemptionCode(claExemptionCode);
      return this;
    }
    
    public ClaimPost.Builder client2Forename(String client2Forename) {
      this.instance.client2Forename(client2Forename);
      return this;
    }
    
    public ClaimPost.Builder client2Surname(String client2Surname) {
      this.instance.client2Surname(client2Surname);
      return this;
    }
    
    public ClaimPost.Builder client2DateOfBirth(String client2DateOfBirth) {
      this.instance.client2DateOfBirth(client2DateOfBirth);
      return this;
    }
    
    public ClaimPost.Builder client2Ucn(String client2Ucn) {
      this.instance.client2Ucn(client2Ucn);
      return this;
    }
    
    public ClaimPost.Builder client2Postcode(String client2Postcode) {
      this.instance.client2Postcode(client2Postcode);
      return this;
    }
    
    public ClaimPost.Builder client2GenderCode(String client2GenderCode) {
      this.instance.client2GenderCode(client2GenderCode);
      return this;
    }
    
    public ClaimPost.Builder client2EthnicityCode(String client2EthnicityCode) {
      this.instance.client2EthnicityCode(client2EthnicityCode);
      return this;
    }
    
    public ClaimPost.Builder client2DisabilityCode(String client2DisabilityCode) {
      this.instance.client2DisabilityCode(client2DisabilityCode);
      return this;
    }
    
    public ClaimPost.Builder client2IsLegallyAided(Boolean client2IsLegallyAided) {
      this.instance.client2IsLegallyAided(client2IsLegallyAided);
      return this;
    }
    
    public ClaimPost.Builder caseId(String caseId) {
      this.instance.caseId(caseId);
      return this;
    }
    
    public ClaimPost.Builder uniqueCaseId(String uniqueCaseId) {
      this.instance.uniqueCaseId(uniqueCaseId);
      return this;
    }
    
    public ClaimPost.Builder caseStageCode(String caseStageCode) {
      this.instance.caseStageCode(caseStageCode);
      return this;
    }
    
    public ClaimPost.Builder stageReachedCode(String stageReachedCode) {
      this.instance.stageReachedCode(stageReachedCode);
      return this;
    }
    
    public ClaimPost.Builder standardFeeCategoryCode(String standardFeeCategoryCode) {
      this.instance.standardFeeCategoryCode(standardFeeCategoryCode);
      return this;
    }
    
    public ClaimPost.Builder outcomeCode(String outcomeCode) {
      this.instance.outcomeCode(outcomeCode);
      return this;
    }
    
    public ClaimPost.Builder designatedAccreditedRepresentativeCode(String designatedAccreditedRepresentativeCode) {
      this.instance.designatedAccreditedRepresentativeCode(designatedAccreditedRepresentativeCode);
      return this;
    }
    
    public ClaimPost.Builder isPostalApplicationAccepted(Boolean isPostalApplicationAccepted) {
      this.instance.isPostalApplicationAccepted(isPostalApplicationAccepted);
      return this;
    }
    
    public ClaimPost.Builder isClient2PostalApplicationAccepted(Boolean isClient2PostalApplicationAccepted) {
      this.instance.isClient2PostalApplicationAccepted(isClient2PostalApplicationAccepted);
      return this;
    }
    
    public ClaimPost.Builder mentalHealthTribunalReference(String mentalHealthTribunalReference) {
      this.instance.mentalHealthTribunalReference(mentalHealthTribunalReference);
      return this;
    }
    
    public ClaimPost.Builder isNrmAdvice(Boolean isNrmAdvice) {
      this.instance.isNrmAdvice(isNrmAdvice);
      return this;
    }
    
    public ClaimPost.Builder followOnWork(String followOnWork) {
      this.instance.followOnWork(followOnWork);
      return this;
    }
    
    public ClaimPost.Builder transferDate(String transferDate) {
      this.instance.transferDate(transferDate);
      return this;
    }
    
    public ClaimPost.Builder exemptionCriteriaSatisfied(String exemptionCriteriaSatisfied) {
      this.instance.exemptionCriteriaSatisfied(exemptionCriteriaSatisfied);
      return this;
    }
    
    public ClaimPost.Builder exceptionalCaseFundingReference(String exceptionalCaseFundingReference) {
      this.instance.exceptionalCaseFundingReference(exceptionalCaseFundingReference);
      return this;
    }
    
    public ClaimPost.Builder isLegacyCase(Boolean isLegacyCase) {
      this.instance.isLegacyCase(isLegacyCase);
      return this;
    }
    
    public ClaimPost.Builder adviceTime(Integer adviceTime) {
      this.instance.adviceTime(adviceTime);
      return this;
    }
    
    public ClaimPost.Builder travelTime(Integer travelTime) {
      this.instance.travelTime(travelTime);
      return this;
    }
    
    public ClaimPost.Builder waitingTime(Integer waitingTime) {
      this.instance.waitingTime(waitingTime);
      return this;
    }
    
    public ClaimPost.Builder netProfitCostsAmount(BigDecimal netProfitCostsAmount) {
      this.instance.netProfitCostsAmount(netProfitCostsAmount);
      return this;
    }
    
    public ClaimPost.Builder netDisbursementAmount(BigDecimal netDisbursementAmount) {
      this.instance.netDisbursementAmount(netDisbursementAmount);
      return this;
    }
    
    public ClaimPost.Builder netCounselCostsAmount(BigDecimal netCounselCostsAmount) {
      this.instance.netCounselCostsAmount(netCounselCostsAmount);
      return this;
    }
    
    public ClaimPost.Builder disbursementsVatAmount(BigDecimal disbursementsVatAmount) {
      this.instance.disbursementsVatAmount(disbursementsVatAmount);
      return this;
    }
    
    public ClaimPost.Builder travelWaitingCostsAmount(BigDecimal travelWaitingCostsAmount) {
      this.instance.travelWaitingCostsAmount(travelWaitingCostsAmount);
      return this;
    }
    
    public ClaimPost.Builder netWaitingCostsAmount(BigDecimal netWaitingCostsAmount) {
      this.instance.netWaitingCostsAmount(netWaitingCostsAmount);
      return this;
    }
    
    public ClaimPost.Builder isVatApplicable(Boolean isVatApplicable) {
      this.instance.isVatApplicable(isVatApplicable);
      return this;
    }
    
    public ClaimPost.Builder isToleranceApplicable(Boolean isToleranceApplicable) {
      this.instance.isToleranceApplicable(isToleranceApplicable);
      return this;
    }
    
    public ClaimPost.Builder priorAuthorityReference(String priorAuthorityReference) {
      this.instance.priorAuthorityReference(priorAuthorityReference);
      return this;
    }
    
    public ClaimPost.Builder isLondonRate(Boolean isLondonRate) {
      this.instance.isLondonRate(isLondonRate);
      return this;
    }
    
    public ClaimPost.Builder adjournedHearingFeeAmount(Integer adjournedHearingFeeAmount) {
      this.instance.adjournedHearingFeeAmount(adjournedHearingFeeAmount);
      return this;
    }
    
    public ClaimPost.Builder isAdditionalTravelPayment(Boolean isAdditionalTravelPayment) {
      this.instance.isAdditionalTravelPayment(isAdditionalTravelPayment);
      return this;
    }
    
    public ClaimPost.Builder costsDamagesRecoveredAmount(BigDecimal costsDamagesRecoveredAmount) {
      this.instance.costsDamagesRecoveredAmount(costsDamagesRecoveredAmount);
      return this;
    }
    
    public ClaimPost.Builder meetingsAttendedCode(String meetingsAttendedCode) {
      this.instance.meetingsAttendedCode(meetingsAttendedCode);
      return this;
    }
    
    public ClaimPost.Builder detentionTravelWaitingCostsAmount(BigDecimal detentionTravelWaitingCostsAmount) {
      this.instance.detentionTravelWaitingCostsAmount(detentionTravelWaitingCostsAmount);
      return this;
    }
    
    public ClaimPost.Builder jrFormFillingAmount(BigDecimal jrFormFillingAmount) {
      this.instance.jrFormFillingAmount(jrFormFillingAmount);
      return this;
    }
    
    public ClaimPost.Builder isEligibleClient(Boolean isEligibleClient) {
      this.instance.isEligibleClient(isEligibleClient);
      return this;
    }
    
    public ClaimPost.Builder courtLocationCode(String courtLocationCode) {
      this.instance.courtLocationCode(courtLocationCode);
      return this;
    }
    
    public ClaimPost.Builder adviceTypeCode(String adviceTypeCode) {
      this.instance.adviceTypeCode(adviceTypeCode);
      return this;
    }
    
    public ClaimPost.Builder medicalReportsCount(Integer medicalReportsCount) {
      this.instance.medicalReportsCount(medicalReportsCount);
      return this;
    }
    
    public ClaimPost.Builder isIrcSurgery(Boolean isIrcSurgery) {
      this.instance.isIrcSurgery(isIrcSurgery);
      return this;
    }
    
    public ClaimPost.Builder surgeryDate(String surgeryDate) {
      this.instance.surgeryDate(surgeryDate);
      return this;
    }
    
    public ClaimPost.Builder surgeryClientsCount(Integer surgeryClientsCount) {
      this.instance.surgeryClientsCount(surgeryClientsCount);
      return this;
    }
    
    public ClaimPost.Builder surgeryMattersCount(Integer surgeryMattersCount) {
      this.instance.surgeryMattersCount(surgeryMattersCount);
      return this;
    }
    
    public ClaimPost.Builder cmrhOralCount(Integer cmrhOralCount) {
      this.instance.cmrhOralCount(cmrhOralCount);
      return this;
    }
    
    public ClaimPost.Builder cmrhTelephoneCount(Integer cmrhTelephoneCount) {
      this.instance.cmrhTelephoneCount(cmrhTelephoneCount);
      return this;
    }
    
    public ClaimPost.Builder aitHearingCentreCode(String aitHearingCentreCode) {
      this.instance.aitHearingCentreCode(aitHearingCentreCode);
      return this;
    }
    
    public ClaimPost.Builder isSubstantiveHearing(Boolean isSubstantiveHearing) {
      this.instance.isSubstantiveHearing(isSubstantiveHearing);
      return this;
    }
    
    public ClaimPost.Builder hoInterview(Integer hoInterview) {
      this.instance.hoInterview(hoInterview);
      return this;
    }
    
    public ClaimPost.Builder localAuthorityNumber(String localAuthorityNumber) {
      this.instance.localAuthorityNumber(localAuthorityNumber);
      return this;
    }
    
    public ClaimPost.Builder submissionPeriod(String submissionPeriod) {
      this.instance.submissionPeriod(submissionPeriod);
      return this;
    }
    
    public ClaimPost.Builder createdByUserId(String createdByUserId) {
      this.instance.createdByUserId(createdByUserId);
      return this;
    }
    
    public ClaimPost.Builder isAmended(Boolean isAmended) {
      this.instance.isAmended(isAmended);
      return this;
    }
    
    public ClaimPost.Builder hasAssessment(Boolean hasAssessment) {
      this.instance.hasAssessment(hasAssessment);
      return this;
    }
    
    public ClaimPost.Builder version(Long version) {
      this.instance.version(version);
      return this;
    }
    
    /**
    * returns a built ClaimPost instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public ClaimPost build() {
      try {
  ...
  */
  public static ClaimPost.Builder builder() {
    return new ClaimPost.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public ClaimPost.Builder toBuilder() {
    ClaimPost.Builder builder = new ClaimPost.Builder();
