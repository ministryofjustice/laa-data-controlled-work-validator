...
public class ClaimResponse implements Serializable {
  ...
  public ClaimResponse id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ClaimResponse submissionId(@Nullable String submissionId) {
  ...
  public ClaimResponse status(@Nullable ClaimStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ClaimResponse scheduleReference(@Nullable String scheduleReference) {
  ...
  public ClaimResponse lineNumber(@Nullable Integer lineNumber) {
  ...
  public ClaimResponse caseReferenceNumber(@Nullable String caseReferenceNumber) {
  ...
  public ClaimResponse uniqueFileNumber(@Nullable String uniqueFileNumber) {
  ...
  public ClaimResponse caseStartDate(@Nullable String caseStartDate) {
  ...
  public ClaimResponse caseConcludedDate(@Nullable String caseConcludedDate) {
  ...
  public ClaimResponse matterTypeCode(@Nullable String matterTypeCode) {
  ...
  public ClaimResponse crimeMatterTypeCode(@Nullable String crimeMatterTypeCode) {
  ...
  public ClaimResponse feeSchemeCode(@Nullable String feeSchemeCode) {
  ...
  public ClaimResponse feeCode(@Nullable String feeCode) {
  ...
  public ClaimResponse procurementAreaCode(@Nullable String procurementAreaCode) {
  ...
  public ClaimResponse accessPointCode(@Nullable String accessPointCode) {
  ...
  public ClaimResponse deliveryLocation(@Nullable String deliveryLocation) {
  ...
  public ClaimResponse representationOrderDate(@Nullable String representationOrderDate) {
  ...
  public ClaimResponse suspectsDefendantsCount(@Nullable Integer suspectsDefendantsCount) {
  ...
  public ClaimResponse policeStationCourtAttendancesCount(@Nullable Integer policeStationCourtAttendancesCount) {
  ...
  public ClaimResponse policeStationCourtPrisonId(@Nullable String policeStationCourtPrisonId) {
  ...
  public ClaimResponse dsccNumber(@Nullable String dsccNumber) {
  ...
  public ClaimResponse maatId(@Nullable String maatId) {
    this.maatId = maatId;
    return this;
  }
  ...
  public ClaimResponse prisonLawPriorApprovalNumber(@Nullable String prisonLawPriorApprovalNumber) {
  ...
  public ClaimResponse isDutySolicitor(@Nullable Boolean isDutySolicitor) {
  ...
  public ClaimResponse isYouthCourt(@Nullable Boolean isYouthCourt) {
  ...
  public ClaimResponse schemeId(@Nullable String schemeId) {
  ...
  public ClaimResponse mediationSessionsCount(@Nullable Integer mediationSessionsCount) {
  ...
  public ClaimResponse mediationTimeMinutes(@Nullable Integer mediationTimeMinutes) {
  ...
  public ClaimResponse outreachLocation(@Nullable String outreachLocation) {
  ...
  public ClaimResponse referralSource(@Nullable String referralSource) {
  ...
  public ClaimResponse clientForename(@Nullable String clientForename) {
  ...
  public ClaimResponse clientSurname(@Nullable String clientSurname) {
  ...
  public ClaimResponse clientDateOfBirth(@Nullable String clientDateOfBirth) {
  ...
  public ClaimResponse uniqueClientNumber(@Nullable String uniqueClientNumber) {
  ...
  public ClaimResponse clientPostcode(@Nullable String clientPostcode) {
  ...
  public ClaimResponse genderCode(@Nullable String genderCode) {
  ...
  public ClaimResponse ethnicityCode(@Nullable String ethnicityCode) {
  ...
  public ClaimResponse disabilityCode(@Nullable String disabilityCode) {
  ...
  public ClaimResponse isLegallyAided(@Nullable Boolean isLegallyAided) {
  ...
  public ClaimResponse clientTypeCode(@Nullable String clientTypeCode) {
  ...
  public ClaimResponse homeOfficeClientNumber(@Nullable String homeOfficeClientNumber) {
  ...
  public ClaimResponse claReferenceNumber(@Nullable String claReferenceNumber) {
  ...
  public ClaimResponse claExemptionCode(@Nullable String claExemptionCode) {
  ...
  public ClaimResponse client2Forename(@Nullable String client2Forename) {
  ...
  public ClaimResponse client2Surname(@Nullable String client2Surname) {
  ...
  public ClaimResponse client2DateOfBirth(@Nullable String client2DateOfBirth) {
  ...
  public ClaimResponse client2Ucn(@Nullable String client2Ucn) {
  ...
  public ClaimResponse client2Postcode(@Nullable String client2Postcode) {
  ...
  public ClaimResponse client2GenderCode(@Nullable String client2GenderCode) {
  ...
  public ClaimResponse client2EthnicityCode(@Nullable String client2EthnicityCode) {
  ...
  public ClaimResponse client2DisabilityCode(@Nullable String client2DisabilityCode) {
  ...
  public ClaimResponse client2IsLegallyAided(@Nullable Boolean client2IsLegallyAided) {
  ...
  public ClaimResponse caseId(@Nullable String caseId) {
    this.caseId = caseId;
    return this;
  }
  ...
  public ClaimResponse uniqueCaseId(@Nullable String uniqueCaseId) {
  ...
  public ClaimResponse caseStageCode(@Nullable String caseStageCode) {
  ...
  public ClaimResponse stageReachedCode(@Nullable String stageReachedCode) {
  ...
  public ClaimResponse standardFeeCategoryCode(@Nullable String standardFeeCategoryCode) {
  ...
  public ClaimResponse outcomeCode(@Nullable String outcomeCode) {
  ...
  public ClaimResponse designatedAccreditedRepresentativeCode(@Nullable String designatedAccreditedRepresentativeCode) {
  ...
  public ClaimResponse isPostalApplicationAccepted(@Nullable Boolean isPostalApplicationAccepted) {
  ...
  public ClaimResponse isClient2PostalApplicationAccepted(@Nullable Boolean isClient2PostalApplicationAccepted) {
  ...
  public ClaimResponse mentalHealthTribunalReference(@Nullable String mentalHealthTribunalReference) {
  ...
  public ClaimResponse isNrmAdvice(@Nullable Boolean isNrmAdvice) {
  ...
  public ClaimResponse followOnWork(@Nullable String followOnWork) {
  ...
  public ClaimResponse transferDate(@Nullable String transferDate) {
  ...
  public ClaimResponse exemptionCriteriaSatisfied(@Nullable String exemptionCriteriaSatisfied) {
  ...
  public ClaimResponse exceptionalCaseFundingReference(@Nullable String exceptionalCaseFundingReference) {
  ...
  public ClaimResponse isLegacyCase(@Nullable Boolean isLegacyCase) {
  ...
  public ClaimResponse adviceTime(@Nullable Integer adviceTime) {
  ...
  public ClaimResponse travelTime(@Nullable Integer travelTime) {
  ...
  public ClaimResponse waitingTime(@Nullable Integer waitingTime) {
  ...
  public ClaimResponse netProfitCostsAmount(@Nullable BigDecimal netProfitCostsAmount) {
  ...
  public ClaimResponse netDisbursementAmount(@Nullable BigDecimal netDisbursementAmount) {
  ...
  public ClaimResponse netCounselCostsAmount(@Nullable BigDecimal netCounselCostsAmount) {
  ...
  public ClaimResponse disbursementsVatAmount(@Nullable BigDecimal disbursementsVatAmount) {
  ...
  public ClaimResponse travelWaitingCostsAmount(@Nullable BigDecimal travelWaitingCostsAmount) {
  ...
  public ClaimResponse netWaitingCostsAmount(@Nullable BigDecimal netWaitingCostsAmount) {
  ...
  public ClaimResponse isVatApplicable(@Nullable Boolean isVatApplicable) {
  ...
  public ClaimResponse isToleranceApplicable(@Nullable Boolean isToleranceApplicable) {
  ...
  public ClaimResponse priorAuthorityReference(@Nullable String priorAuthorityReference) {
  ...
  public ClaimResponse isLondonRate(@Nullable Boolean isLondonRate) {
  ...
  public ClaimResponse adjournedHearingFeeAmount(@Nullable Integer adjournedHearingFeeAmount) {
  ...
  public ClaimResponse isAdditionalTravelPayment(@Nullable Boolean isAdditionalTravelPayment) {
  ...
  public ClaimResponse costsDamagesRecoveredAmount(@Nullable BigDecimal costsDamagesRecoveredAmount) {
  ...
  public ClaimResponse meetingsAttendedCode(@Nullable String meetingsAttendedCode) {
  ...
  public ClaimResponse detentionTravelWaitingCostsAmount(@Nullable BigDecimal detentionTravelWaitingCostsAmount) {
  ...
  public ClaimResponse jrFormFillingAmount(@Nullable BigDecimal jrFormFillingAmount) {
  ...
  public ClaimResponse isEligibleClient(@Nullable Boolean isEligibleClient) {
  ...
  public ClaimResponse courtLocationCode(@Nullable String courtLocationCode) {
  ...
  public ClaimResponse adviceTypeCode(@Nullable String adviceTypeCode) {
  ...
  public ClaimResponse medicalReportsCount(@Nullable Integer medicalReportsCount) {
  ...
  public ClaimResponse isIrcSurgery(@Nullable Boolean isIrcSurgery) {
  ...
  public ClaimResponse surgeryDate(@Nullable String surgeryDate) {
  ...
  public ClaimResponse surgeryClientsCount(@Nullable Integer surgeryClientsCount) {
  ...
  public ClaimResponse surgeryMattersCount(@Nullable Integer surgeryMattersCount) {
  ...
  public ClaimResponse cmrhOralCount(@Nullable Integer cmrhOralCount) {
  ...
  public ClaimResponse cmrhTelephoneCount(@Nullable Integer cmrhTelephoneCount) {
  ...
  public ClaimResponse aitHearingCentreCode(@Nullable String aitHearingCentreCode) {
  ...
  public ClaimResponse isSubstantiveHearing(@Nullable Boolean isSubstantiveHearing) {
  ...
  public ClaimResponse hoInterview(@Nullable Integer hoInterview) {
  ...
  public ClaimResponse localAuthorityNumber(@Nullable String localAuthorityNumber) {
  ...
  public ClaimResponse submissionPeriod(@Nullable String submissionPeriod) {
  ...
  public ClaimResponse createdByUserId(@Nullable String createdByUserId) {
  ...
  public ClaimResponse isAmended(@Nullable Boolean isAmended) {
  ...
  public ClaimResponse hasAssessment(@Nullable Boolean hasAssessment) {
  ...
  public ClaimResponse version(@Nullable Long version) {
  ...
  public ClaimResponse totalWarnings(@Nullable Integer totalWarnings) {
  ...
  public ClaimResponse feeCalculationResponse(@Nullable FeeCalculationPatch feeCalculationResponse) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, claimResponse.id) &&
        Objects.equals(this.submissionId, claimResponse.submissionId) &&
        Objects.equals(this.status, claimResponse.status) &&
        Objects.equals(this.scheduleReference, claimResponse.scheduleReference) &&
        Objects.equals(this.lineNumber, claimResponse.lineNumber) &&
        Objects.equals(this.caseReferenceNumber, claimResponse.caseReferenceNumber) &&
        Objects.equals(this.uniqueFileNumber, claimResponse.uniqueFileNumber) &&
        Objects.equals(this.caseStartDate, claimResponse.caseStartDate) &&
        Objects.equals(this.caseConcludedDate, claimResponse.caseConcludedDate) &&
        Objects.equals(this.matterTypeCode, claimResponse.matterTypeCode) &&
        Objects.equals(this.crimeMatterTypeCode, claimResponse.crimeMatterTypeCode) &&
        Objects.equals(this.feeSchemeCode, claimResponse.feeSchemeCode) &&
        Objects.equals(this.feeCode, claimResponse.feeCode) &&
        Objects.equals(this.procurementAreaCode, claimResponse.procurementAreaCode) &&
        Objects.equals(this.accessPointCode, claimResponse.accessPointCode) &&
        Objects.equals(this.deliveryLocation, claimResponse.deliveryLocation) &&
        Objects.equals(this.representationOrderDate, claimResponse.representationOrderDate) &&
        Objects.equals(this.suspectsDefendantsCount, claimResponse.suspectsDefendantsCount) &&
        Objects.equals(this.policeStationCourtAttendancesCount, claimResponse.policeStationCourtAttendancesCount) &&
        Objects.equals(this.policeStationCourtPrisonId, claimResponse.policeStationCourtPrisonId) &&
        Objects.equals(this.dsccNumber, claimResponse.dsccNumber) &&
        Objects.equals(this.maatId, claimResponse.maatId) &&
        Objects.equals(this.prisonLawPriorApprovalNumber, claimResponse.prisonLawPriorApprovalNumber) &&
        Objects.equals(this.isDutySolicitor, claimResponse.isDutySolicitor) &&
        Objects.equals(this.isYouthCourt, claimResponse.isYouthCourt) &&
        Objects.equals(this.schemeId, claimResponse.schemeId) &&
        Objects.equals(this.mediationSessionsCount, claimResponse.mediationSessionsCount) &&
        Objects.equals(this.mediationTimeMinutes, claimResponse.mediationTimeMinutes) &&
        Objects.equals(this.outreachLocation, claimResponse.outreachLocation) &&
        Objects.equals(this.referralSource, claimResponse.referralSource) &&
        Objects.equals(this.clientForename, claimResponse.clientForename) &&
        Objects.equals(this.clientSurname, claimResponse.clientSurname) &&
        Objects.equals(this.clientDateOfBirth, claimResponse.clientDateOfBirth) &&
        Objects.equals(this.uniqueClientNumber, claimResponse.uniqueClientNumber) &&
        Objects.equals(this.clientPostcode, claimResponse.clientPostcode) &&
        Objects.equals(this.genderCode, claimResponse.genderCode) &&
        Objects.equals(this.ethnicityCode, claimResponse.ethnicityCode) &&
        Objects.equals(this.disabilityCode, claimResponse.disabilityCode) &&
        Objects.equals(this.isLegallyAided, claimResponse.isLegallyAided) &&
        Objects.equals(this.clientTypeCode, claimResponse.clientTypeCode) &&
        Objects.equals(this.homeOfficeClientNumber, claimResponse.homeOfficeClientNumber) &&
        Objects.equals(this.claReferenceNumber, claimResponse.claReferenceNumber) &&
        Objects.equals(this.claExemptionCode, claimResponse.claExemptionCode) &&
        Objects.equals(this.client2Forename, claimResponse.client2Forename) &&
        Objects.equals(this.client2Surname, claimResponse.client2Surname) &&
        Objects.equals(this.client2DateOfBirth, claimResponse.client2DateOfBirth) &&
        Objects.equals(this.client2Ucn, claimResponse.client2Ucn) &&
        Objects.equals(this.client2Postcode, claimResponse.client2Postcode) &&
        Objects.equals(this.client2GenderCode, claimResponse.client2GenderCode) &&
        Objects.equals(this.client2EthnicityCode, claimResponse.client2EthnicityCode) &&
        Objects.equals(this.client2DisabilityCode, claimResponse.client2DisabilityCode) &&
        Objects.equals(this.client2IsLegallyAided, claimResponse.client2IsLegallyAided) &&
        Objects.equals(this.caseId, claimResponse.caseId) &&
        Objects.equals(this.uniqueCaseId, claimResponse.uniqueCaseId) &&
        Objects.equals(this.caseStageCode, claimResponse.caseStageCode) &&
        Objects.equals(this.stageReachedCode, claimResponse.stageReachedCode) &&
        Objects.equals(this.standardFeeCategoryCode, claimResponse.standardFeeCategoryCode) &&
        Objects.equals(this.outcomeCode, claimResponse.outcomeCode) &&
        Objects.equals(this.designatedAccreditedRepresentativeCode, claimResponse.designatedAccreditedRepresentativeCode) &&
        Objects.equals(this.isPostalApplicationAccepted, claimResponse.isPostalApplicationAccepted) &&
        Objects.equals(this.isClient2PostalApplicationAccepted, claimResponse.isClient2PostalApplicationAccepted) &&
        Objects.equals(this.mentalHealthTribunalReference, claimResponse.mentalHealthTribunalReference) &&
        Objects.equals(this.isNrmAdvice, claimResponse.isNrmAdvice) &&
        Objects.equals(this.followOnWork, claimResponse.followOnWork) &&
        Objects.equals(this.transferDate, claimResponse.transferDate) &&
        Objects.equals(this.exemptionCriteriaSatisfied, claimResponse.exemptionCriteriaSatisfied) &&
        Objects.equals(this.exceptionalCaseFundingReference, claimResponse.exceptionalCaseFundingReference) &&
        Objects.equals(this.isLegacyCase, claimResponse.isLegacyCase) &&
        Objects.equals(this.adviceTime, claimResponse.adviceTime) &&
        Objects.equals(this.travelTime, claimResponse.travelTime) &&
        Objects.equals(this.waitingTime, claimResponse.waitingTime) &&
        Objects.equals(this.netProfitCostsAmount, claimResponse.netProfitCostsAmount) &&
        Objects.equals(this.netDisbursementAmount, claimResponse.netDisbursementAmount) &&
        Objects.equals(this.netCounselCostsAmount, claimResponse.netCounselCostsAmount) &&
        Objects.equals(this.disbursementsVatAmount, claimResponse.disbursementsVatAmount) &&
        Objects.equals(this.travelWaitingCostsAmount, claimResponse.travelWaitingCostsAmount) &&
        Objects.equals(this.netWaitingCostsAmount, claimResponse.netWaitingCostsAmount) &&
        Objects.equals(this.isVatApplicable, claimResponse.isVatApplicable) &&
        Objects.equals(this.isToleranceApplicable, claimResponse.isToleranceApplicable) &&
        Objects.equals(this.priorAuthorityReference, claimResponse.priorAuthorityReference) &&
        Objects.equals(this.isLondonRate, claimResponse.isLondonRate) &&
        Objects.equals(this.adjournedHearingFeeAmount, claimResponse.adjournedHearingFeeAmount) &&
        Objects.equals(this.isAdditionalTravelPayment, claimResponse.isAdditionalTravelPayment) &&
        Objects.equals(this.costsDamagesRecoveredAmount, claimResponse.costsDamagesRecoveredAmount) &&
        Objects.equals(this.meetingsAttendedCode, claimResponse.meetingsAttendedCode) &&
        Objects.equals(this.detentionTravelWaitingCostsAmount, claimResponse.detentionTravelWaitingCostsAmount) &&
        Objects.equals(this.jrFormFillingAmount, claimResponse.jrFormFillingAmount) &&
        Objects.equals(this.isEligibleClient, claimResponse.isEligibleClient) &&
        Objects.equals(this.courtLocationCode, claimResponse.courtLocationCode) &&
        Objects.equals(this.adviceTypeCode, claimResponse.adviceTypeCode) &&
        Objects.equals(this.medicalReportsCount, claimResponse.medicalReportsCount) &&
        Objects.equals(this.isIrcSurgery, claimResponse.isIrcSurgery) &&
        Objects.equals(this.surgeryDate, claimResponse.surgeryDate) &&
        Objects.equals(this.surgeryClientsCount, claimResponse.surgeryClientsCount) &&
        Objects.equals(this.surgeryMattersCount, claimResponse.surgeryMattersCount) &&
        Objects.equals(this.cmrhOralCount, claimResponse.cmrhOralCount) &&
        Objects.equals(this.cmrhTelephoneCount, claimResponse.cmrhTelephoneCount) &&
        Objects.equals(this.aitHearingCentreCode, claimResponse.aitHearingCentreCode) &&
        Objects.equals(this.isSubstantiveHearing, claimResponse.isSubstantiveHearing) &&
        Objects.equals(this.hoInterview, claimResponse.hoInterview) &&
        Objects.equals(this.localAuthorityNumber, claimResponse.localAuthorityNumber) &&
        Objects.equals(this.submissionPeriod, claimResponse.submissionPeriod) &&
        Objects.equals(this.createdByUserId, claimResponse.createdByUserId) &&
        Objects.equals(this.isAmended, claimResponse.isAmended) &&
        Objects.equals(this.hasAssessment, claimResponse.hasAssessment) &&
        Objects.equals(this.version, claimResponse.version) &&
        Objects.equals(this.totalWarnings, claimResponse.totalWarnings) &&
        Objects.equals(this.feeCalculationResponse, claimResponse.feeCalculationResponse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, submissionId, status, scheduleReference, lineNumber, caseReferenceNumber, uniqueFileNumber, caseStartDate, caseConcludedDate, matterTypeCode, crimeMatterTypeCode, feeSchemeCode, feeCode, procurementAreaCode, accessPointCode, deliveryLocation, representationOrderDate, suspectsDefendantsCount, policeStationCourtAttendancesCount, policeStationCourtPrisonId, dsccNumber, maatId, prisonLawPriorApprovalNumber, isDutySolicitor, isYouthCourt, schemeId, mediationSessionsCount, mediationTimeMinutes, outreachLocation, referralSource, clientForename, clientSurname, clientDateOfBirth, uniqueClientNumber, clientPostcode, genderCode, ethnicityCode, disabilityCode, isLegallyAided, clientTypeCode, homeOfficeClientNumber, claReferenceNumber, claExemptionCode, client2Forename, client2Surname, client2DateOfBirth, client2Ucn, client2Postcode, client2GenderCode, client2EthnicityCode, client2DisabilityCode, client2IsLegallyAided, caseId, uniqueCaseId, caseStageCode, stageReachedCode, standardFeeCategoryCode, outcomeCode, designatedAccreditedRepresentativeCode, isPostalApplicationAccepted, isClient2PostalApplicationAccepted, mentalHealthTribunalReference, isNrmAdvice, followOnWork, transferDate, exemptionCriteriaSatisfied, exceptionalCaseFundingReference, isLegacyCase, adviceTime, travelTime, waitingTime, netProfitCostsAmount, netDisbursementAmount, netCounselCostsAmount, disbursementsVatAmount, travelWaitingCostsAmount, netWaitingCostsAmount, isVatApplicable, isToleranceApplicable, priorAuthorityReference, isLondonRate, adjournedHearingFeeAmount, isAdditionalTravelPayment, costsDamagesRecoveredAmount, meetingsAttendedCode, detentionTravelWaitingCostsAmount, jrFormFillingAmount, isEligibleClient, courtLocationCode, adviceTypeCode, medicalReportsCount, isIrcSurgery, surgeryDate, surgeryClientsCount, surgeryMattersCount, cmrhOralCount, cmrhTelephoneCount, aitHearingCentreCode, isSubstantiveHearing, hoInterview, localAuthorityNumber, submissionPeriod, createdByUserId, isAmended, hasAssessment, version, totalWarnings, feeCalculationResponse);
  }
  ...
  public static class Builder {
    ...
    protected Builder copyOf(ClaimResponse value) { 
    ...
    public ClaimResponse.Builder submissionId(String submissionId) {
      this.instance.submissionId(submissionId);
      return this;
    }
    
    public ClaimResponse.Builder status(ClaimStatus status) {
      this.instance.status(status);
      return this;
    }
    
    public ClaimResponse.Builder scheduleReference(String scheduleReference) {
      this.instance.scheduleReference(scheduleReference);
      return this;
    }
    
    public ClaimResponse.Builder lineNumber(Integer lineNumber) {
      this.instance.lineNumber(lineNumber);
      return this;
    }
    
    public ClaimResponse.Builder caseReferenceNumber(String caseReferenceNumber) {
      this.instance.caseReferenceNumber(caseReferenceNumber);
      return this;
    }
    
    public ClaimResponse.Builder uniqueFileNumber(String uniqueFileNumber) {
      this.instance.uniqueFileNumber(uniqueFileNumber);
      return this;
    }
    
    public ClaimResponse.Builder caseStartDate(String caseStartDate) {
      this.instance.caseStartDate(caseStartDate);
      return this;
    }
    
    public ClaimResponse.Builder caseConcludedDate(String caseConcludedDate) {
      this.instance.caseConcludedDate(caseConcludedDate);
      return this;
    }
    
    public ClaimResponse.Builder matterTypeCode(String matterTypeCode) {
      this.instance.matterTypeCode(matterTypeCode);
      return this;
    }
    
    public ClaimResponse.Builder crimeMatterTypeCode(String crimeMatterTypeCode) {
      this.instance.crimeMatterTypeCode(crimeMatterTypeCode);
      return this;
    }
    
    public ClaimResponse.Builder feeSchemeCode(String feeSchemeCode) {
      this.instance.feeSchemeCode(feeSchemeCode);
      return this;
    }
    
    public ClaimResponse.Builder feeCode(String feeCode) {
      this.instance.feeCode(feeCode);
      return this;
    }
    
    public ClaimResponse.Builder procurementAreaCode(String procurementAreaCode) {
      this.instance.procurementAreaCode(procurementAreaCode);
      return this;
    }
    
    public ClaimResponse.Builder accessPointCode(String accessPointCode) {
      this.instance.accessPointCode(accessPointCode);
      return this;
    }
    
    public ClaimResponse.Builder deliveryLocation(String deliveryLocation) {
      this.instance.deliveryLocation(deliveryLocation);
      return this;
    }
    
    public ClaimResponse.Builder representationOrderDate(String representationOrderDate) {
      this.instance.representationOrderDate(representationOrderDate);
      return this;
    }
    
    public ClaimResponse.Builder suspectsDefendantsCount(Integer suspectsDefendantsCount) {
      this.instance.suspectsDefendantsCount(suspectsDefendantsCount);
      return this;
    }
    
    public ClaimResponse.Builder policeStationCourtAttendancesCount(Integer policeStationCourtAttendancesCount) {
      this.instance.policeStationCourtAttendancesCount(policeStationCourtAttendancesCount);
      return this;
    }
    
    public ClaimResponse.Builder policeStationCourtPrisonId(String policeStationCourtPrisonId) {
      this.instance.policeStationCourtPrisonId(policeStationCourtPrisonId);
      return this;
    }
    
    public ClaimResponse.Builder dsccNumber(String dsccNumber) {
      this.instance.dsccNumber(dsccNumber);
      return this;
    }
    
    public ClaimResponse.Builder maatId(String maatId) {
      this.instance.maatId(maatId);
      return this;
    }
    
    public ClaimResponse.Builder prisonLawPriorApprovalNumber(String prisonLawPriorApprovalNumber) {
      this.instance.prisonLawPriorApprovalNumber(prisonLawPriorApprovalNumber);
      return this;
    }
    
    public ClaimResponse.Builder isDutySolicitor(Boolean isDutySolicitor) {
      this.instance.isDutySolicitor(isDutySolicitor);
      return this;
    }
    
    public ClaimResponse.Builder isYouthCourt(Boolean isYouthCourt) {
      this.instance.isYouthCourt(isYouthCourt);
      return this;
    }
    
    public ClaimResponse.Builder schemeId(String schemeId) {
      this.instance.schemeId(schemeId);
      return this;
    }
    
    public ClaimResponse.Builder mediationSessionsCount(Integer mediationSessionsCount) {
      this.instance.mediationSessionsCount(mediationSessionsCount);
      return this;
    }
    
    public ClaimResponse.Builder mediationTimeMinutes(Integer mediationTimeMinutes) {
      this.instance.mediationTimeMinutes(mediationTimeMinutes);
      return this;
    }
    
    public ClaimResponse.Builder outreachLocation(String outreachLocation) {
      this.instance.outreachLocation(outreachLocation);
      return this;
    }
    
    public ClaimResponse.Builder referralSource(String referralSource) {
      this.instance.referralSource(referralSource);
      return this;
    }
    
    public ClaimResponse.Builder clientForename(String clientForename) {
      this.instance.clientForename(clientForename);
      return this;
    }
    
    public ClaimResponse.Builder clientSurname(String clientSurname) {
      this.instance.clientSurname(clientSurname);
      return this;
    }
    
    public ClaimResponse.Builder clientDateOfBirth(String clientDateOfBirth) {
      this.instance.clientDateOfBirth(clientDateOfBirth);
      return this;
    }
    
    public ClaimResponse.Builder uniqueClientNumber(String uniqueClientNumber) {
      this.instance.uniqueClientNumber(uniqueClientNumber);
      return this;
    }
    
    public ClaimResponse.Builder clientPostcode(String clientPostcode) {
      this.instance.clientPostcode(clientPostcode);
      return this;
    }
    
    public ClaimResponse.Builder genderCode(String genderCode) {
      this.instance.genderCode(genderCode);
      return this;
    }
    
    public ClaimResponse.Builder ethnicityCode(String ethnicityCode) {
      this.instance.ethnicityCode(ethnicityCode);
      return this;
    }
    
    public ClaimResponse.Builder disabilityCode(String disabilityCode) {
      this.instance.disabilityCode(disabilityCode);
      return this;
    }
    
    public ClaimResponse.Builder isLegallyAided(Boolean isLegallyAided) {
      this.instance.isLegallyAided(isLegallyAided);
      return this;
    }
    
    public ClaimResponse.Builder clientTypeCode(String clientTypeCode) {
      this.instance.clientTypeCode(clientTypeCode);
      return this;
    }
    
    public ClaimResponse.Builder homeOfficeClientNumber(String homeOfficeClientNumber) {
      this.instance.homeOfficeClientNumber(homeOfficeClientNumber);
      return this;
    }
    
    public ClaimResponse.Builder claReferenceNumber(String claReferenceNumber) {
      this.instance.claReferenceNumber(claReferenceNumber);
      return this;
    }
    
    public ClaimResponse.Builder claExemptionCode(String claExemptionCode) {
      this.instance.claExemptionCode(claExemptionCode);
      return this;
    }
    
    public ClaimResponse.Builder client2Forename(String client2Forename) {
      this.instance.client2Forename(client2Forename);
      return this;
    }
    
    public ClaimResponse.Builder client2Surname(String client2Surname) {
      this.instance.client2Surname(client2Surname);
      return this;
    }
    
    public ClaimResponse.Builder client2DateOfBirth(String client2DateOfBirth) {
      this.instance.client2DateOfBirth(client2DateOfBirth);
      return this;
    }
    
    public ClaimResponse.Builder client2Ucn(String client2Ucn) {
      this.instance.client2Ucn(client2Ucn);
      return this;
    }
    
    public ClaimResponse.Builder client2Postcode(String client2Postcode) {
      this.instance.client2Postcode(client2Postcode);
      return this;
    }
    
    public ClaimResponse.Builder client2GenderCode(String client2GenderCode) {
      this.instance.client2GenderCode(client2GenderCode);
      return this;
    }
    
    public ClaimResponse.Builder client2EthnicityCode(String client2EthnicityCode) {
      this.instance.client2EthnicityCode(client2EthnicityCode);
      return this;
    }
    
    public ClaimResponse.Builder client2DisabilityCode(String client2DisabilityCode) {
      this.instance.client2DisabilityCode(client2DisabilityCode);
      return this;
    }
    
    public ClaimResponse.Builder client2IsLegallyAided(Boolean client2IsLegallyAided) {
      this.instance.client2IsLegallyAided(client2IsLegallyAided);
      return this;
    }
    
    public ClaimResponse.Builder caseId(String caseId) {
      this.instance.caseId(caseId);
      return this;
    }
    
    public ClaimResponse.Builder uniqueCaseId(String uniqueCaseId) {
      this.instance.uniqueCaseId(uniqueCaseId);
      return this;
    }
    
    public ClaimResponse.Builder caseStageCode(String caseStageCode) {
      this.instance.caseStageCode(caseStageCode);
      return this;
    }
    
    public ClaimResponse.Builder stageReachedCode(String stageReachedCode) {
      this.instance.stageReachedCode(stageReachedCode);
      return this;
    }
    
    public ClaimResponse.Builder standardFeeCategoryCode(String standardFeeCategoryCode) {
      this.instance.standardFeeCategoryCode(standardFeeCategoryCode);
      return this;
    }
    
    public ClaimResponse.Builder outcomeCode(String outcomeCode) {
      this.instance.outcomeCode(outcomeCode);
      return this;
    }
    
    public ClaimResponse.Builder designatedAccreditedRepresentativeCode(String designatedAccreditedRepresentativeCode) {
      this.instance.designatedAccreditedRepresentativeCode(designatedAccreditedRepresentativeCode);
      return this;
    }
    
    public ClaimResponse.Builder isPostalApplicationAccepted(Boolean isPostalApplicationAccepted) {
      this.instance.isPostalApplicationAccepted(isPostalApplicationAccepted);
      return this;
    }
    
    public ClaimResponse.Builder isClient2PostalApplicationAccepted(Boolean isClient2PostalApplicationAccepted) {
      this.instance.isClient2PostalApplicationAccepted(isClient2PostalApplicationAccepted);
      return this;
    }
    
    public ClaimResponse.Builder mentalHealthTribunalReference(String mentalHealthTribunalReference) {
      this.instance.mentalHealthTribunalReference(mentalHealthTribunalReference);
      return this;
    }
    
    public ClaimResponse.Builder isNrmAdvice(Boolean isNrmAdvice) {
      this.instance.isNrmAdvice(isNrmAdvice);
      return this;
    }
    
    public ClaimResponse.Builder followOnWork(String followOnWork) {
      this.instance.followOnWork(followOnWork);
      return this;
    }
    
    public ClaimResponse.Builder transferDate(String transferDate) {
      this.instance.transferDate(transferDate);
      return this;
    }
    
    public ClaimResponse.Builder exemptionCriteriaSatisfied(String exemptionCriteriaSatisfied) {
      this.instance.exemptionCriteriaSatisfied(exemptionCriteriaSatisfied);
      return this;
    }
    
    public ClaimResponse.Builder exceptionalCaseFundingReference(String exceptionalCaseFundingReference) {
      this.instance.exceptionalCaseFundingReference(exceptionalCaseFundingReference);
      return this;
    }
    
    public ClaimResponse.Builder isLegacyCase(Boolean isLegacyCase) {
      this.instance.isLegacyCase(isLegacyCase);
      return this;
    }
    
    public ClaimResponse.Builder adviceTime(Integer adviceTime) {
      this.instance.adviceTime(adviceTime);
      return this;
    }
    
    public ClaimResponse.Builder travelTime(Integer travelTime) {
      this.instance.travelTime(travelTime);
      return this;
    }
    
    public ClaimResponse.Builder waitingTime(Integer waitingTime) {
      this.instance.waitingTime(waitingTime);
      return this;
    }
    
    public ClaimResponse.Builder netProfitCostsAmount(BigDecimal netProfitCostsAmount) {
      this.instance.netProfitCostsAmount(netProfitCostsAmount);
      return this;
    }
    
    public ClaimResponse.Builder netDisbursementAmount(BigDecimal netDisbursementAmount) {
      this.instance.netDisbursementAmount(netDisbursementAmount);
      return this;
    }
    
    public ClaimResponse.Builder netCounselCostsAmount(BigDecimal netCounselCostsAmount) {
      this.instance.netCounselCostsAmount(netCounselCostsAmount);
      return this;
    }
    
    public ClaimResponse.Builder disbursementsVatAmount(BigDecimal disbursementsVatAmount) {
      this.instance.disbursementsVatAmount(disbursementsVatAmount);
      return this;
    }
    
    public ClaimResponse.Builder travelWaitingCostsAmount(BigDecimal travelWaitingCostsAmount) {
      this.instance.travelWaitingCostsAmount(travelWaitingCostsAmount);
      return this;
    }
    
    public ClaimResponse.Builder netWaitingCostsAmount(BigDecimal netWaitingCostsAmount) {
      this.instance.netWaitingCostsAmount(netWaitingCostsAmount);
      return this;
    }
    
    public ClaimResponse.Builder isVatApplicable(Boolean isVatApplicable) {
      this.instance.isVatApplicable(isVatApplicable);
      return this;
    }
    
    public ClaimResponse.Builder isToleranceApplicable(Boolean isToleranceApplicable) {
      this.instance.isToleranceApplicable(isToleranceApplicable);
      return this;
    }
    
    public ClaimResponse.Builder priorAuthorityReference(String priorAuthorityReference) {
      this.instance.priorAuthorityReference(priorAuthorityReference);
      return this;
    }
    
    public ClaimResponse.Builder isLondonRate(Boolean isLondonRate) {
      this.instance.isLondonRate(isLondonRate);
      return this;
    }
    
    public ClaimResponse.Builder adjournedHearingFeeAmount(Integer adjournedHearingFeeAmount) {
      this.instance.adjournedHearingFeeAmount(adjournedHearingFeeAmount);
      return this;
    }
    
    public ClaimResponse.Builder isAdditionalTravelPayment(Boolean isAdditionalTravelPayment) {
      this.instance.isAdditionalTravelPayment(isAdditionalTravelPayment);
      return this;
    }
    
    public ClaimResponse.Builder costsDamagesRecoveredAmount(BigDecimal costsDamagesRecoveredAmount) {
      this.instance.costsDamagesRecoveredAmount(costsDamagesRecoveredAmount);
      return this;
    }
    
    public ClaimResponse.Builder meetingsAttendedCode(String meetingsAttendedCode) {
      this.instance.meetingsAttendedCode(meetingsAttendedCode);
      return this;
    }
    
    public ClaimResponse.Builder detentionTravelWaitingCostsAmount(BigDecimal detentionTravelWaitingCostsAmount) {
      this.instance.detentionTravelWaitingCostsAmount(detentionTravelWaitingCostsAmount);
      return this;
    }
    
    public ClaimResponse.Builder jrFormFillingAmount(BigDecimal jrFormFillingAmount) {
      this.instance.jrFormFillingAmount(jrFormFillingAmount);
      return this;
    }
    
    public ClaimResponse.Builder isEligibleClient(Boolean isEligibleClient) {
      this.instance.isEligibleClient(isEligibleClient);
      return this;
    }
    
    public ClaimResponse.Builder courtLocationCode(String courtLocationCode) {
      this.instance.courtLocationCode(courtLocationCode);
      return this;
    }
    
    public ClaimResponse.Builder adviceTypeCode(String adviceTypeCode) {
      this.instance.adviceTypeCode(adviceTypeCode);
      return this;
    }
    
    public ClaimResponse.Builder medicalReportsCount(Integer medicalReportsCount) {
      this.instance.medicalReportsCount(medicalReportsCount);
      return this;
    }
    
    public ClaimResponse.Builder isIrcSurgery(Boolean isIrcSurgery) {
      this.instance.isIrcSurgery(isIrcSurgery);
      return this;
    }
    
    public ClaimResponse.Builder surgeryDate(String surgeryDate) {
      this.instance.surgeryDate(surgeryDate);
      return this;
    }
    
    public ClaimResponse.Builder surgeryClientsCount(Integer surgeryClientsCount) {
      this.instance.surgeryClientsCount(surgeryClientsCount);
      return this;
    }
    
    public ClaimResponse.Builder surgeryMattersCount(Integer surgeryMattersCount) {
      this.instance.surgeryMattersCount(surgeryMattersCount);
      return this;
    }
    
    public ClaimResponse.Builder cmrhOralCount(Integer cmrhOralCount) {
      this.instance.cmrhOralCount(cmrhOralCount);
      return this;
    }
    
    public ClaimResponse.Builder cmrhTelephoneCount(Integer cmrhTelephoneCount) {
      this.instance.cmrhTelephoneCount(cmrhTelephoneCount);
      return this;
    }
    
    public ClaimResponse.Builder aitHearingCentreCode(String aitHearingCentreCode) {
      this.instance.aitHearingCentreCode(aitHearingCentreCode);
      return this;
    }
    
    public ClaimResponse.Builder isSubstantiveHearing(Boolean isSubstantiveHearing) {
      this.instance.isSubstantiveHearing(isSubstantiveHearing);
      return this;
    }
    
    public ClaimResponse.Builder hoInterview(Integer hoInterview) {
      this.instance.hoInterview(hoInterview);
      return this;
    }
    
    public ClaimResponse.Builder localAuthorityNumber(String localAuthorityNumber) {
      this.instance.localAuthorityNumber(localAuthorityNumber);
      return this;
    }
    
    public ClaimResponse.Builder submissionPeriod(String submissionPeriod) {
      this.instance.submissionPeriod(submissionPeriod);
      return this;
    }
    
    public ClaimResponse.Builder createdByUserId(String createdByUserId) {
      this.instance.createdByUserId(createdByUserId);
      return this;
    }
    
    public ClaimResponse.Builder isAmended(Boolean isAmended) {
      this.instance.isAmended(isAmended);
      return this;
    }
    
    public ClaimResponse.Builder hasAssessment(Boolean hasAssessment) {
      this.instance.hasAssessment(hasAssessment);
      return this;
    }
    
    public ClaimResponse.Builder version(Long version) {
      this.instance.version(version);
      return this;
    }
    
    public ClaimResponse.Builder totalWarnings(Integer totalWarnings) {
      this.instance.totalWarnings(totalWarnings);
      return this;
    }
    
    public ClaimResponse.Builder feeCalculationResponse(FeeCalculationPatch feeCalculationResponse) {
      this.instance.feeCalculationResponse(feeCalculationResponse);
      return this;
    }
    
    /**
    * returns a built ClaimResponse instance.
    *
  ...
  */
  public ClaimResponse.Builder toBuilder() {
    ClaimResponse.Builder builder = new ClaimResponse.Builder();
