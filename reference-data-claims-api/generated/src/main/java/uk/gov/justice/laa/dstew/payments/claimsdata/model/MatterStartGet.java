...
public class MatterStartGet implements Serializable {
  ...
  public MatterStartGet scheduleReference(@Nullable String scheduleReference) {
  ...
  public MatterStartGet categoryCode(@Nullable CategoryCode categoryCode) {
  ...
  public MatterStartGet procurementAreaCode(@Nullable String procurementAreaCode) {
  ...
  public MatterStartGet accessPointCode(@Nullable String accessPointCode) {
  ...
  public MatterStartGet deliveryLocation(@Nullable String deliveryLocation) {
  ...
  public MatterStartGet mediationType(@Nullable MediationType mediationType) {
  ...
  public MatterStartGet numberOfMatterStarts(@Nullable Integer numberOfMatterStarts) {
  ...
  public MatterStartGet createdByUserId(@Nullable String createdByUserId) {
  ...
  public boolean equals(Object o) {
    ...
    MatterStartGet matterStartGet = (MatterStartGet) o;
    return Objects.equals(this.scheduleReference, matterStartGet.scheduleReference) &&
        Objects.equals(this.categoryCode, matterStartGet.categoryCode) &&
        Objects.equals(this.procurementAreaCode, matterStartGet.procurementAreaCode) &&
        Objects.equals(this.accessPointCode, matterStartGet.accessPointCode) &&
        Objects.equals(this.deliveryLocation, matterStartGet.deliveryLocation) &&
        Objects.equals(this.mediationType, matterStartGet.mediationType) &&
        Objects.equals(this.numberOfMatterStarts, matterStartGet.numberOfMatterStarts) &&
        Objects.equals(this.createdByUserId, matterStartGet.createdByUserId);
  }
  ...
  public String toString() {
    ...
    sb.append("class MatterStartGet {\n");
  ...
  public static class Builder {
    ...
    private MatterStartGet instance;

    public Builder() {
      this(new MatterStartGet());
    }

    protected Builder(MatterStartGet instance) {
      this.instance = instance;
    }

    protected Builder copyOf(MatterStartGet value) { 
    ...
    public MatterStartGet.Builder scheduleReference(String scheduleReference) {
      this.instance.scheduleReference(scheduleReference);
      return this;
    }
    
    public MatterStartGet.Builder categoryCode(CategoryCode categoryCode) {
      this.instance.categoryCode(categoryCode);
      return this;
    }
    
    public MatterStartGet.Builder procurementAreaCode(String procurementAreaCode) {
      this.instance.procurementAreaCode(procurementAreaCode);
      return this;
    }
    
    public MatterStartGet.Builder accessPointCode(String accessPointCode) {
      this.instance.accessPointCode(accessPointCode);
      return this;
    }
    
    public MatterStartGet.Builder deliveryLocation(String deliveryLocation) {
      this.instance.deliveryLocation(deliveryLocation);
      return this;
    }
    
    public MatterStartGet.Builder mediationType(MediationType mediationType) {
      this.instance.mediationType(mediationType);
      return this;
    }
    
    public MatterStartGet.Builder numberOfMatterStarts(Integer numberOfMatterStarts) {
      this.instance.numberOfMatterStarts(numberOfMatterStarts);
      return this;
    }
    
    public MatterStartGet.Builder createdByUserId(String createdByUserId) {
      this.instance.createdByUserId(createdByUserId);
      return this;
    }
    
    /**
    * returns a built MatterStartGet instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public MatterStartGet build() {
      try {
  ...
  */
  public static MatterStartGet.Builder builder() {
    return new MatterStartGet.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public MatterStartGet.Builder toBuilder() {
    MatterStartGet.Builder builder = new MatterStartGet.Builder();
