...
/**
 * Matter start for a submission
 */

@Schema(name = "matter_start_fields", description = "Matter start for a submission")
@JsonTypeName("matter_start_fields")
...
public class MatterStartFields implements Serializable {
  ...
  public MatterStartFields scheduleReference(@Nullable String scheduleReference) {
  ...
  public MatterStartFields categoryCode(@Nullable CategoryCode categoryCode) {
  ...
  public MatterStartFields procurementAreaCode(@Nullable String procurementAreaCode) {
  ...
  public MatterStartFields accessPointCode(@Nullable String accessPointCode) {
  ...
  public MatterStartFields deliveryLocation(@Nullable String deliveryLocation) {
  ...
  public MatterStartFields mediationType(@Nullable MediationType mediationType) {
  ...
  public MatterStartFields numberOfMatterStarts(@Nullable Integer numberOfMatterStarts) {
  ...
  public MatterStartFields createdByUserId(@Nullable String createdByUserId) {
  ...
  public boolean equals(Object o) {
    ...
    MatterStartFields matterStartFields = (MatterStartFields) o;
    return Objects.equals(this.scheduleReference, matterStartFields.scheduleReference) &&
        Objects.equals(this.categoryCode, matterStartFields.categoryCode) &&
        Objects.equals(this.procurementAreaCode, matterStartFields.procurementAreaCode) &&
        Objects.equals(this.accessPointCode, matterStartFields.accessPointCode) &&
        Objects.equals(this.deliveryLocation, matterStartFields.deliveryLocation) &&
        Objects.equals(this.mediationType, matterStartFields.mediationType) &&
        Objects.equals(this.numberOfMatterStarts, matterStartFields.numberOfMatterStarts) &&
        Objects.equals(this.createdByUserId, matterStartFields.createdByUserId);
  }
  ...
  public String toString() {
    ...
    sb.append("class MatterStartFields {\n");
  ...
  public static class Builder {
    ...
    private MatterStartFields instance;

    public Builder() {
      this(new MatterStartFields());
    }

    protected Builder(MatterStartFields instance) {
      this.instance = instance;
    }

    protected Builder copyOf(MatterStartFields value) { 
    ...
    public MatterStartFields.Builder scheduleReference(String scheduleReference) {
      this.instance.scheduleReference(scheduleReference);
      return this;
    }
    
    public MatterStartFields.Builder categoryCode(CategoryCode categoryCode) {
      this.instance.categoryCode(categoryCode);
      return this;
    }
    
    public MatterStartFields.Builder procurementAreaCode(String procurementAreaCode) {
      this.instance.procurementAreaCode(procurementAreaCode);
      return this;
    }
    
    public MatterStartFields.Builder accessPointCode(String accessPointCode) {
      this.instance.accessPointCode(accessPointCode);
      return this;
    }
    
    public MatterStartFields.Builder deliveryLocation(String deliveryLocation) {
      this.instance.deliveryLocation(deliveryLocation);
      return this;
    }
    
    public MatterStartFields.Builder mediationType(MediationType mediationType) {
      this.instance.mediationType(mediationType);
      return this;
    }
    
    public MatterStartFields.Builder numberOfMatterStarts(Integer numberOfMatterStarts) {
      this.instance.numberOfMatterStarts(numberOfMatterStarts);
      return this;
    }
    
    public MatterStartFields.Builder createdByUserId(String createdByUserId) {
      this.instance.createdByUserId(createdByUserId);
      return this;
    }
    
    /**
    * returns a built MatterStartFields instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public MatterStartFields build() {
      try {
  ...
  */
  public static MatterStartFields.Builder builder() {
    return new MatterStartFields.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public MatterStartFields.Builder toBuilder() {
    MatterStartFields.Builder builder = new MatterStartFields.Builder();
