...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-17T22:25:27.890682Z[Europe/London]", comments = "Generator version: 7.18.0")
public class ValidationIssue implements Serializable {
  ...
  @Schema(name = "technical_message", example = "Invalid value 'XYZ' for field 'claim.area_of_law'. Expected one of: [LEGAL HELP, CRIME LOWER, MEDIATION]", description = "Detailed technical description for debugging (may include field paths, expected values, etc.)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
