...
public class EnumConverterConfiguration {
    ...
    @Bean(name = "org.openapitools.configuration.EnumConverterConfiguration.validationSeverityConverter")
    Converter<String, ValidationSeverity> validationSeverityConverter() {
        return new Converter<String, ValidationSeverity>() {
            @Override
            public ValidationSeverity convert(String source) {
                return ValidationSeverity.fromValue(source);
            }
        };
    }
